<template>
    <div>
        ...
        <el-dialog title="用户编辑" width="30%" :visible.sync="visible" id="userDialog">
          <div class="thisContain">
            <el-form ref="form" :model="addUserList" :rules="rules" class="demo-form-inline demo-ruleForm aditUser inputControl" size="mini" label-width="90px">
                <!-- string类型 -->
