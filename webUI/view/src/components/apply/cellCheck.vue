  ...
  <div class="cellCheck">
    <el-form :inline="true" :model="selectedCell" class="form-setting">
      <el-form-item label="选择小区(规划)：">
        <el-select v-model="selectedCell.planeCellId" placeholder="请选择小区" size="mini" class="widthControl">
          <el-option
      ...
      <el-form-item label="选择小区(验收)：">
        <el-select v-model="selectedCell.resultCellId" placeholder="请选择小区" size="mini" class="widthControl">
          <el-option
            v-for="item in cellArray"
            :key="item.cellID"
            :label="item.cellName"
