<template>
    <div class="contain mission inputControl">
        ...
        <el-form :inline="true" :model="formInline" ref="form7" :rules="rules" class="demo-form-inline missionStyle demo-ruleForm" size="mini" label-width="120px">
          <!-- 时间戳 -->
          <el-form-item label="计划完成日期" prop="taskPlanCompleteTime" class="finishTime">
