========================================================================
		ActiveX Control DLL : OCXPROJECT
========================================================================

ControlWizard has created this project for your OCXPROJECT ActiveX Control
...
that make up your OCXPROJECT ActiveX Control DLL.
...
OcxProjectCtl.h
	This file contains the declaration of the COcxProjectCtrl C++ class.

OcxProjectCtl.cpp
	This file contains the implementation of the COcxProjectCtrl C++ class.

OcxProjectPpg.h
	This file contains the declaration of the COcxProjectPropPage C++ class.

OcxProjectPpg.cpp
	This file contains the implementation of the COcxProjectPropPage C++ class.

OcxProjectCtl.bmp
	This file contains a bitmap that a container will use to represent the
	COcxProjectCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file ocxProject.rc.
