========================================================================
		ActiveX Control DLL : ACTIVEXDEMO
========================================================================

ControlWizard has created this project for your ACTIVEXDEMO ActiveX Control
...
that make up your ACTIVEXDEMO ActiveX Control DLL.
...
ActiveXDemoCtl.h
	This file contains the declaration of the CActiveXDemoCtrl C++ class.

ActiveXDemoCtl.cpp
	This file contains the implementation of the CActiveXDemoCtrl C++ class.

ActiveXDemoPpg.h
	This file contains the declaration of the CActiveXDemoPropPage C++ class.

ActiveXDemoPpg.cpp
	This file contains the implementation of the CActiveXDemoPropPage C++ class.

ActiveXDemoCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CActiveXDemoCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file ActiveXDemo.rc.
