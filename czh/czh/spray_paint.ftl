...
<head>
    ...
    <link charset="UTF-8" rel="stylesheet" href="${contextPath}/css/promotion/car_cosmetology/spray_paint.css?v=1.0">
    <style>
        body {
            overflow: hidden;
        }
...
<div id="main" class="main">
    <div class="header">
        <img src="${contextPath}/images/promotion/car_cosmetology/img_banner_paint@2x.png" alt="">
    </div>
    <div class="content">
        <div class="con-top">
        ...
        <div class="con-lists">
            <ul class="clear">
                <li onclick="toDetail(200)">
                    <i class="car_icon"></i>
                    <p>安心喷漆(一副)</p>
                    <p class="money">215元起<span>350元</span></p>
                </li>
                <li onclick="toDetail(201)">
                    <i class="car_icon"></i>
                    <p>安心喷漆(三副)</p>
                    <p class="money">598元起<span>1100元</span></p>
                </li>
               <#-- <li onclick="toDetail(191)">
                    <i class="car_icon"></i>
                    <p class="mgt">安心喷漆(一副)</p>
                    <p class="money mgt2">130元起<span>260元</span></p>
                    <p class="area">限广东省(其他城市)</p>
                </li>
                <li onclick="toDetail(191)">
                    <i class="car_icon"></i>
                    <p class="mgt">安心喷漆(三副)</p>
                    <p class="money mgt2">130元起<span>260元</span></p>
                    <p class="area">限特定区域</p>
                </li>-->
            </ul>
        </div>
    </div>
...
<script>
    ...
    var ssotoken = getParams("ssotoken");
