...
<head>
    ...
    <link charset="UTF-8" rel="stylesheet" href="${contextPath}/css/promotion/car_cosmetology/wash_car.css?v=1.0">
    <style>
        body {
            overflow: hidden;
        }
...
<div id="main" class="main">
    <div class="header">
        <img src="${contextPath}/images/promotion/car_cosmetology/img_banner_clean@2x.png" alt="">
    </div>
    <div class="content">
        <div class="con-top">
        ...
        <div class="con-lists">
            <ul id="conList" class="clear">
                <#if participatedWashCar>
                    <li onclick="toDetail(159)">
                        <i class="car_icon"></i>
                        <p>单次洗车</p>
                        <p class="money">30元<span>45元</span></p>
                    </li>
                <#else>
                    <li onclick="toDetail(159)">
                        <i class="first"></i>
                ...
                <li onclick="toDetail(153)">
                    <i class="car_icon"></i>
                    <p class="mgt">12次洗车</p>
                    <p class="money mgt2">299元<span>480元</span></p>
                    <p class="area">限珠三角地区</p>
                </li>
                <li onclick="toDetail(152)">
                    <i class="car_icon"></i>
                    <p class="mgt">10次洗车</p>
                    <p class="money mgt2">199元起<span>400元</span></p>
                    <p class="area">限非珠三角地区</p>
                </li>
                <#--<li onclick="toDetail(186)">
                    <i class="car_icon"></i>
                    <p class="mgt">12次洗车</p>
                    <p class="money mgt2">130元起<span>260元</span></p>
                    <p class="area">限特定区域使用</p>
                </li>-->
            </ul>
        </div>
    </div>
...
<script>
    ...
    function toDetail(id) {
        //正式地址 https://czhbbc.iauto360.cn/wap/passport-gologin.html?ssotoken=__ssotoken__&type=item&item_id=159  https://testbbc.iauto360.cn/wap/passport-gologin.html
