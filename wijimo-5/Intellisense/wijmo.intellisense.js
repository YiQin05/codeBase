...
wijmo.setLicenseKey = function(licenseKey) {
/// <summary>Sets the license key that identifies licensed Wijmo applications.
/// 
...
/// It only checks the internal consistency of the key provided.</summary>
/// <param name="licenseKey" type="String" optional="false">String containing the license key to use in this application.</param>
}
wijmo.Key = {
// The backspace key.
Back: 8,
...
wijmo.isEmpty = function(obj) {
/// <summary>Determines whether an object is empty
/// (contains no enumerable properties).</summary>
/// <param name="obj" type="Object" optional="false">Object to test.</param>
/// <returns type="Boolean"></returns>
}
...
/// <param name="e" type="Element" optional="false">Element to check.</param>
...
/// <param name="e" type="Element" optional="false">Element that will have the class added.</param>
/// <param name="className" type="String" optional="false">Class (or space-separated list of classes) to add to the element.</param>
}
wijmo.removeClass = function(e, className) {
/// <summary>Removes a class from an element.</summary>
/// <param name="e" type="Element" optional="false">Element that will have the class removed.</param>
/// <param name="className" type="String" optional="false">Class (or space-separated list of classes) to remove from the element.</param>
}
...
/// <param name="addOrRemove" type="Boolean" optional="true">Whether to add or remove the class. If not provided, toggle the class.</param>
}
wijmo.setAttribute = function(e, name, value, keep) {
...
/// <param name="keep" type="Boolean" optional="true">Whether to keep original attribute if present.</param>
}
wijmo.setAriaLabel = function(e, value) {
/// <summary>Sets or clears an element's <b>aria-label</b> attribute.</summary>
/// <param name="e" type="Element" optional="false">Element that will be updated.</param>
/// <param name="value" type="String" optional="true">Value of the aria label, or null to remove the label
/// from the element.</param>
}
...
/// <param name="e" type="Object" optional="false">HTMLInputElement or HTMLTextAreaElement to select.</param>
...
wijmo.disableAutoComplete = function(e) {
/// <summary>Disables the autocomplete, autocorrect, autocapitalize, and spellcheck
/// properties of an input element.</summary>
/// <param name="e" type="HTMLInputElement" optional="false">The input element.</param>
}
wijmo.removeChild = function(e) {
/// <summary>Safely removes an element from the DOM tree.</summary>
/// <param name="e" type="Node" optional="false">Element to remove from the DOM tree.</param>
}
...
/// <returns type="Boolean">True if the focus was set, false if a focusable element was not found.</returns>
}
wijmo.getElement = function(selector) {
/// <summary>Gets an element from a query selector.</summary>
...
/// <summary>Finds the closest ancestor (including the original element) that satisfies a selector.</summary>
...
/// <returns type="Node">The closest ancestor that satisfies the selector, or null if not found.</returns>
}
wijmo.closestClass = function(e, className) {
/// <summary>Finds the closest ancestor (including the original element) that satisfies a class selector.</summary>
/// <param name="e" type="Object" optional="false">Element where the search should start.</param>
/// <param name="className" type="String" optional="false">A string containing the class name to match elements against.</param>
/// <returns type="Node">The closest ancestor that has the specified class name, or null if not found.</returns>
}
...
/// <param name="settings" type="Object" optional="true">An optional object used to configure the request.</param>
...
wijmo.Globalize.parseDate = function(value, format, defaultDate) {
...
/// <param name="defaultDate" type="Date" optional="true">Date to use as a reference in case date parts are
/// missing form the input (e.g. when format = 'MM/dd').</param>
...
/// <field name="handlerCount" type="Number">Gets the number of handlers added to this event.</field>
if (arguments[0]) {
...
wijmo.Event._wjDict = _wjMerge({}, {hasHandlers:2,handlerCount:2});
...
/// <param name="element" type="Object" optional="false">The DOM element that hosts the control, or a CSS selector for the host element (e.g. '#theCtrl').</param>
...
/// <field name="refreshing" type="wijmo.Event">Occurs when the control is about to refresh its contents.</field>
/// <field name="refreshed" type="wijmo.Event">Occurs after the control has refreshed its contents.</field>
...
this.refreshing = new wijmo.Event('wijmo.EventArgs');
this.refreshed = new wijmo.Event('wijmo.EventArgs');
_wjReownEvents(this);
}
wijmo.Control.prototype = new ControlBase();
...
wijmo.Control.prototype.addEventListener = function(target, type, fn, capture, passive) {
...
/// <a target="_blank" href="https://developer.mozilla.org/en-US/docs/Web/API/EventTarget/addEventListener#Improving_scrolling_performance_with_passive_listeners">Improving scrolling performance with passive listeners</a>.</summary>
...
/// <param name="capture" type="Boolean" optional="true">Whether the listener should be handled by the control before it is handled by the target element.</param>
/// <param name="passive" type="Boolean" optional="true">Indicates that the handler will never call <b>preventDefault()</b>.</param>
}
...
wijmo.Control.prototype.onRefreshing = function(e) {
/// <summary>Raises the @see:refreshing event.</summary>
/// <param name="e" type="wijmo.EventArgs" optional="true"></param>
}
wijmo.Control.prototype.onRefreshed = function(e) {
/// <summary>Raises the @see:refreshed event.</summary>
/// <param name="e" type="wijmo.EventArgs" optional="true"></param>
}
wijmo.Control._wjDict = _wjMerge(ControlBase._wjDict, {hostElement:2,rightToLeft:2,isUpdating:2,isTouching:2,isDisabled:2,gotFocus:1,lostFocus:1,refreshing:1,refreshed:1});
...
wijmo.collections.ArrayBase.prototype = new Array();
wijmo.collections.ArrayBase._wjDict = _wjMerge(Array._wjDict, {});
...
/// <returns type="this">A copy of the sorted array.</returns>
}
...
/// <field name="sortNullsFirst" type="Boolean">Gets or sets a value that determines whether null values should appear
/// first or last when the collection is sorted (regardless of sort direction).
/// 
/// This property is false by default, which causes null values to appear
/// last on the sorted collection. This is  also the default behavior in Excel.</field>
...
/// <field name="sortDescriptions" type="wijmo.collections.ObservableArray">Gets an array of @see:SortDescription objects that describe how the items
...
/// 
/// The default value for the property is <b>true</b>.</field>
/// <field name="gap" type="Number">Gets or sets the distance between the tooltip and the target element.
/// 
/// The default value for the property is <b>6</b> pixels.</field>
...
/// target element.
/// 
/// The default value for the property is <b>false</b>.</field>
/// <field name="showDelay" type="Number">Gets or sets the delay, in milliseconds, before showing the tooltip
/// after the mouse enters the target element.
/// 
/// The default value for the property is <b>500</b> milliseconds.</field>
/// <field name="hideDelay" type="Number">Gets or sets the delay, in milliseconds, before hiding the tooltip
...
/// the tooltip display by changing the event parameters.</field>
...
/// <param name="copyStyles" type="Object" optional="true">Whether to copy font and color styles from the reference element, or an element to use as the style source.</param>
/// <returns type="Object">An interval id that you can use to suspend the fade-in animation.</returns>
}
...
/// <param name="remove" type="Object" optional="true">Whether to remove the popup from the DOM or just to hide it.
/// This parameter may be a boolean or a callback function that gets invoked
/// after the popup has been removed from the DOM.</param>
/// <param name="fadeOut" type="Boolean" optional="true">Whether to use a fade-out animation to make the popup disappear gradually.</param>
/// <returns type="Object">An interval id that you can use to suspend the fade-out animation.</returns>
}
...
/// <field name="title" type="String">Gets or sets the document title.
/// 
/// Setting this property to null causes the @see:PrintDocument
/// to use the title from the current document.</field>
/// <field name="copyCss" type="Boolean">Gets or sets a value that determines whether the @see:PrintDocument
...
wijmo._ClickRepeater = function(element) {
/// <summary>Initializes a new instance of the @see:_ClickRepeater class.</summary>
/// <param name="element" type="HTMLElement" optional="false">Element that will raise click events while the mouse is down.</param>
/// <returns type="wijmo._ClickRepeater"></returns>
/// <field name="element" type="HTMLElement">Gets or sets the element that will raise click events while the mouse is down.</field>
/// <field name="disabled" type="Boolean">Gets or sets a value that determines whether this repeater is disabled.</field>
this._wjClassName = 'wijmo._ClickRepeater';
_wjReownEvents(this);
}
wijmo._ClickRepeater._wjDict = _wjMerge({}, {element:2,disabled:2});
wijmo._ClickRepeater._wjClass = true;
...
/// <field name="virtualizationThreshold" type="Object">Gets or sets the minimum number of rows and/or columns required to enable
/// virtualization.
/// 
...
/// </pre></field>
/// <field name="autoGenerateColumns" type="Boolean">Gets or sets a value that determines whether the grid should generate
...
/// });</pre>
/// 
/// The default value for this property is <b>true</b>.</field>
...
/// 
/// The default value for this property is <b>true</b>.</field>
/// <field name="autoScroll" type="Boolean">Gets or sets a value that determines whether the grid should automatically
...
/// 
/// The default value for this property is <b>true</b>.</field>
/// <field name="autoSearch" type="Boolean">Gets or sets a value that determines whether the grid should search for
...
/// case-insensitive.
/// 
/// The default value for this property is <b>false</b>.</field>
...
/// property.
/// 
/// The default value for this property is <b>AllowResizing.Columns</b>.</field>
...
/// 
/// The default value for this property is <b>AutoSizeMode.Both</b>.</field>
/// <field name="quickAutoSize" type="Boolean">Gets or sets a value that determines whether the grid should optimize
...
/// 
/// The default value for this property is <b>false</b>.</field>
/// <field name="allowMerging" type="wijmo.grid.AllowMerging">Gets or sets which parts of the grid provide cell merging.
/// 
/// The default value for this property is <b>AllowMerging.None</b>.</field>
...
/// 
/// The default value for this property is <b>HeadersVisibility.None</b>.</field>
...
/// 
/// The default value for this property is <b>true</b>.</field>
/// <field name="showGroups" type="Boolean">Gets or sets a value that determines whether the @see:FlexGrid should insert
...
/// 
/// The default value for this property is <b>AllowDragging.Columns</b>.</field>
/// <field name="itemsSource" type="Object">Gets or sets the array or @see:ICollectionView that contains items
/// shown on the grid.</field>
/// <field name="collectionView" type="wijmo.collections.ICollectionView">Gets the @see:ICollectionView that contains the grid data.
/// 
...
/// by the grid to support currency, editing, and sorting.</field>
...
/// 
/// The default value for this property is <b>0</b>.</field>
...
/// panel to act as the sort row.</field>
...
/// last or first cells are selected.</field>
...
/// <field name="itemsSourceChanging" type="wijmo.Event">Occurs after the grid has been bound to a new items source.</field>
...
/// (see the @see:autoClipboard property).
/// 
/// The event handler may cancel the paste operation.</field>
...
this.itemsSourceChanging = new wijmo.Event('wijmo.CancelEventArgs');
...
/// <param name="y" type="Object" optional="true">Y coordinate of the point in page coordinates (if the first parameter is a number).</param>
...
/// <summary>Resizes a column to fit its content.
/// 
...
/// and therefore will not be able to auto-size the columns.</summary>
...
/// able to auto-size the columns.</summary>
...
/// <summary>Resizes a row to fit its content.
/// 
/// This method only works if the grid is visible. If its host element
/// has not been added to the DOM, or if any of the grid's ancestor
/// elements are hidden, the grid will not be able to measure the cells
/// and therefore will not be able to auto-size the rows.</summary>
...
/// <summary>Resizes a range of rows to fit their content.
/// 
/// This method only works if the grid is visible. If its host element
/// has not been added to the DOM, or if any of the grid's ancestor
/// elements is hidden, the grid will not be able to measure the cells
...
wijmo.grid.FlexGrid.prototype.scrollIntoView = function(r, c, refresh) {
/// <summary>Scrolls the grid to bring a specific cell into view.
/// 
...
/// <param name="refresh" type="Boolean" optional="true">Optional parameter that determines whether the grid
/// should refresh to show the new scroll position immediately.</param>
...
/// <param name="fullEdit" type="Boolean" optional="true">Whether to stay in edit mode when the user presses the cursor keys. Defaults to true.</param>
...
wijmo.grid.FlexGrid.prototype.toggleDropDownList = function() {
/// <summary>Toggles the drop-down list-box associated with the currently selected
/// cell.
/// 
...
wijmo.grid.FlexGrid.prototype.onItemsSourceChanging = function(e) {
...
/// <field name="refresh" type="Boolean">Gets or sets a value that determines whether the grid should refresh
/// all its contents after the edits are done.</field>
...
wijmo.grid.CellEditEndingEventArgs._wjDict = _wjMerge(wijmo.grid.CellRangeEventArgs._wjDict, {stayInEditMode:2,refresh:2});
...
/// <field name="isVisible" type="Boolean">Gets a value that indicates whether the row or column is
...
/// the element to use the parent collection's default size.</field>
...
/// and min and max sizes.</field>
/// <field name="allowResizing" type="Boolean">Gets or sets a value that indicates whether the user can resize
/// the row or column with the mouse.
/// 
/// The default value for this property is <b>true</b>.</field>
/// <field name="allowDragging" type="Boolean">Gets or sets a value that indicates whether the user can move the row or column to a new position with the mouse.
/// 
/// The default value for this property is <b>true</b>.</field>
/// <field name="allowMerging" type="Boolean">Gets or sets a value that indicates whether cells in the
/// row or column can be merged.
/// 
/// The default value for this property is <b>false</b>.</field>
/// <field name="isSelected" type="Boolean">Gets or sets a value that indicates whether the row or column
/// is selected.</field>
/// <field name="isReadOnly" type="Boolean">Gets or sets a value that indicates whether cells in the
...
/// 
/// The default value for this property is <b>false</b>.</field>
/// <field name="wordWrap" type="Boolean">Gets or sets a value that indicates whether the content of cells in
/// this row or column should wrap to fit the available column width.
/// 
/// The default value for this property is <b>false</b>.</field>
/// <field name="multiLine" type="Boolean">Gets or sets a value that indicates whether the content of cells in
...
/// <field name="grid" type="wijmo.grid.FlexGrid">Gets the @see:FlexGrid that owns this row or column.</field>
...
wijmo.grid.RowCol._wjDict = _wjMerge({}, {visible:2,isVisible:2,pos:2,index:2,visibleIndex:2,size:2,renderSize:2,allowResizing:2,allowDragging:2,allowMerging:2,isSelected:2,isReadOnly:2,isContentHtml:2,wordWrap:2,multiLine:2,cssClass:2,grid:2,collectionView:2});
...
/// 
/// Cell drop-downs require the wijmo.input module to be loaded.</field>
/// <field name="inputType" type="String">Gets or sets the "type" attribute of the HTML input element used to
...
/// In these cases, try setting the property to "number" or simply "text."</field>
...
/// <field name="maxLength" type="Number">Gets or sets the maximum number of characters that the can
/// be entered into the cell.
/// 
/// This property is set to null by default, which allows entries
/// with any number of characters.</field>
...
/// <field name="minWidth" type="Number">Gets or sets the minimum width of the column.
/// 
/// This property is set to null by default, which means there
/// is the minimum width is zero.</field>
/// <field name="maxWidth" type="Number">Gets or sets the maximum width (in pixels) of the column.
/// 
/// This property is set to null by default, which means there
/// is no maximum width.</field>
/// <field name="quickAutoSize" type="Boolean">Gets or sets a value that determines whether the grid should optimize
...
/// that display plain text and don't have templates.</field>
...
/// <field name="describedById" type="String">Gets or sets the ID of an element that contains a description
/// of the column.
/// 
/// The ID is used as the value of the <b>aria-describedby</b>
/// attribute for the column header element.</field>
...
wijmo.grid.Column._wjDict = _wjMerge(wijmo.grid.RowCol._wjDict, {name:2,dataType:2,isRequired:2,showDropDown:2,dropDownCssClass:2,inputType:2,mask:2,maxLength:2,binding:2,sortMemberPath:2,width:2,minWidth:2,maxWidth:2,quickAutoSize:2,renderWidth:2,align:2,header:2,dataMap:2,format:2,allowSorting:2,currentSort:2,aggregate:2,describedById:2});
...
/// <field name="grid" type="wijmo.grid.FlexGrid">Gets the @see:FlexGrid that owns this collection.</field>
...
wijmo.grid.RowColCollection._wjDict = _wjMerge(wijmo.collections.ObservableArray._wjDict, {grid:2,defaultSize:2,frozen:2,minSize:2,maxSize:2,visibleLength:2});
...
/// descriptions, use the column's @see:Column.describedById instead.</field>
...
wijmo.grid.ColumnCollection._wjDict = _wjMerge(wijmo.grid.RowColCollection._wjDict, {describedById:2,firstVisibleIndex:2});
...
/// <field name="ariaLabel" type="String">Gets or sets a string used as an ARIA label for all rows in this
/// collection.
/// 
...
wijmo.grid.RowCollection._wjDict = _wjMerge(wijmo.grid.RowColCollection._wjDict, {ariaLabel:2,maxGroupLevel:2});
...
/// <summary>Initializes a new instance of the @see:_ImeHandler class
/// and attaches it to a @see:FlexGrid.</summary>
...
wijmo.grid.filter.FilterCondition = function(filter) {
/// <summary>Initializes a new instance of the @see:FilterCondition class.</summary>
/// <param name="filter" type="wijmo.grid.filter.ConditionFilter" optional="true">The @see:ConditionFilter that owns this @see:FilterCondition.</param>
...
wijmo.grid.filter.FlexGridFilter = function(grid, options) {
...
/// <param name="options" type="Object" optional="true">Initialization options for the @see:FlexGridFilter.</param>
...
/// </pre>
/// 
/// The default value for this property is <b>FilterType.Both</b>.</field>
/// <field name="filterDefinition" type="String">Gets or sets the current filter definition as a JSON string.</field>
/// <field name="activeEditor" type="wijmo.grid.filter.ColumnFilterEditor">Gets the active @see:ColumnFilterEditor.
/// 
/// This property allows you to customize the filter editor when
/// handling the @see:filterChanging event.
/// It returns null when no filters are being edited.</field>
...
wijmo.grid.filter.FlexGridFilter.prototype.editColumnFilter = function(col, ht, refElem) {
...
/// <param name="refElem" type="HTMLElement" optional="true">An HTMLElement to use as a reference for positioning the editor.</param>
}
...
wijmo.grid.filter.FlexGridFilter._wjDict = _wjMerge({}, {grid:2,filterColumns:2,showFilterIcons:2,showSortButtons:2,defaultFilterType:2,filterDefinition:2,activeEditor:2,filterApplied:1,filterChanging:1,filterChanged:1});
...
/// 
/// The default value for this property is <b>true</b>.</field>
/// <field name="maxGroups" type="Number">Gets or sets the maximum number of groups allowed.
/// 
/// Setting this property to -1 allows any number of groups
/// to be created. Setting it to zero prevents any grouping.
/// 
/// The default value for this property is <b>6</b>.</field>
/// <field name="placeholder" type="String">Gets or sets a string to display in the control when it contains no groups.
/// 
/// The default value for this property is <b>''</b> (empty string).</field>
...
/// <field name="filter" type="wijmo.grid.filter.FlexGridFilter">Gets or sets the @see:grid.filter.FlexGridFilter to use for filtering
/// the grid data.
/// 
...
/// associated with the groups.</field>
...
wijmo.grid.grouppanel.GroupPanel._wjDict = _wjMerge(wijmo.Control._wjDict, {hideGroupedColumns:2,maxGroups:2,placeholder:2,grid:2,filter:2});
wijmo.grid.grouppanel.GroupPanel._wjClass = true;
wijmo.grid.detail = wijmo.grid.detail || { _wjModule: true };
wijmo.grid.detail.KeyAction = {
...
/// <field name="detailVisibilityMode" type="wijmo.grid.detail.DetailVisibilityMode">Gets or sets a value that determines when row details are displayed.
/// 
/// The default value for this property is <b>DetailVisibilityMode.ExpandSingle</b>.</field>
/// <field name="maxHeight" type="Number">Gets or sets the maximum height of the detail rows, in pixels.
/// 
/// The default value for this property is <b>null</b>, which means
/// there's no upper limit to the detail row height.</field>
...
/// the Enter key to toggle the display of the row details.</field>
...
wijmo.grid.detail.FlexGridDetailProvider.prototype.getDetailRow = function(row) {
/// <summary>Gets the detail row associated with a given grid row.</summary>
...
wijmo.grid.detail.FlexGridDetailProvider._wjDict = _wjMerge({}, {grid:2,detailVisibilityMode:2,maxHeight:2,isAnimated:2,keyActionEnter:2,createDetailCell:2,disposeDetailCell:2,rowHasDetail:2});
...
/// 
/// The default value for this property is <b>false</b>.</field>
/// <field name="collapsedHeadersChanging" type="wijmo.Event">Occurs after the value of the @see:collapsedHeaders property changes.</field>
/// <field name="collapsedHeadersChanged" type="wijmo.Event">Occurs after the value of the @see:collapsedHeaders property has changed.</field>
this._wjClassName = 'wijmo.grid.multirow.MultiRow';
this.collapsedHeadersChanging = new wijmo.Event('wijmo.CancelEventArgs');
this.collapsedHeadersChanged = new wijmo.Event('wijmo.EventArgs');
_wjReownEvents(this);
}
...
wijmo.grid.multirow.MultiRow.prototype.onCollapsedHeadersChanging = function(e) {
/// <summary>Raises the @see:collapsedHeadersChanging event.</summary>
/// <param name="e" type="wijmo.CancelEventArgs" optional="false">@see:CancelEventArgs that contains the event data.</param>
/// <returns type="Boolean">True if the event was not canceled.</returns>
}
wijmo.grid.multirow.MultiRow.prototype.onCollapsedHeadersChanged = function(e) {
/// <summary>Raises the @see:collapsedHeadersChanged event.</summary>
/// <param name="e" type="wijmo.EventArgs" optional="true"></param>
}
wijmo.grid.multirow.MultiRow._wjDict = _wjMerge(wijmo.grid.FlexGrid._wjDict, {layoutDefinition:2,rowsPerItem:2,centerHeadersVertically:2,collapsedHeaders:2,showHeaderCollapseButton:2,collapsedHeadersChanging:1,collapsedHeadersChanged:1});
...
/// 
/// The default value for this property is <b>false</b>.</field>
/// <field name="isRequired" type="Boolean">Gets or sets a value that determines whether the control value must be
...
/// It defaults to false for the @see:AutoComplete control.</field>
/// <field name="placeholder" type="String">Gets or sets the string shown as a hint when the control is empty.</field>
/// <field name="isDroppedDown" type="Boolean">Gets or sets a value that indicates whether the drop down is currently
/// visible.
/// 
/// The default value for this property is <b>false</b>.</field>
...
/// <field name="showDropDownButton" type="Boolean">Gets or sets a value that indicates whether the control should
/// display a drop-down button.
/// 
/// The default value for this property is <b>true</b>.</field>
/// <field name="autoExpandSelection" type="Boolean">Gets or sets a value that indicates whether the control should
...
/// <field name="value" type="Date">Gets or sets the currently selected date.
/// 
/// The default value for this property is the current date.</field>
...
/// 
/// The default value for this property is <b>DateSelectionMode.Day</b>.</field>
/// <field name="isReadOnly" type="Boolean">Gets or sets a value that indicates whether the user can modify
/// the control value using the mouse and keyboard.
/// 
/// The default value for this property is <b>false</b>.</field>
/// <field name="repeatButtons" type="Boolean">Gets or sets a value that determines whether the calendar buttons
/// should act as repeat buttons, firing repeatedly as the button
/// remains pressed.
/// 
/// The default value for this property is <b>true</b>.</field>
/// <field name="showYearPicker" type="Boolean">Gets or sets a value that determines whether the calendar should
...
/// 
/// The default value for this property is <b>'yyyy'</b>.</field>
/// <field name="formatMonths" type="String">Gets or sets the format used to display the months
/// in year view.
/// 
/// The default value for this property is <b>'MMM'</b>.</field>
...
/// 
/// The default value for this property is <b>true</b>.</field>
/// <field name="monthView" type="Boolean">Gets or sets a value indicating whether the calendar displays
/// a month or a year.
/// 
/// The default value for this property is <b>true</b>.</field>
...
/// 
/// The default value for this property is <b>false</b>.</field>
/// <field name="value" type="String">Gets or sets the currently selected color.
/// 
/// This property defaults to 'white'.</field>
...
/// <field name="itemsSource" type="Object">Gets or sets the array or @see:ICollectionView object that contains
...
/// <field name="showGroups" type="Boolean">Gets or sets a value that determines whether the @see:ListBox should
...
/// 
/// The default value for this property is <b>false</b>.</field>
/// <field name="isContentHtml" type="Boolean">Gets or sets a value indicating whether items contain plain
/// text or HTML.
/// 
/// The default value for this property is <b>false</b>.</field>
/// <field name="itemFormatter" type="Function">Gets or sets a function used to customize the values shown on
/// the list.
...
///   }
/// </pre></field>
/// <field name="displayMemberPath" type="String">Gets or sets the name of the property to use as the visual
/// representation of the items.</field>
...
/// <field name="checkedMemberPath" type="Object">Gets or sets the name of the property used to control
...
/// to retrieve the list of items that are currently checked.</field>
/// <field name="itemRole" type="String">Gets or sets the value or the "role" attribute added to the
/// list items. The default value for this property is "option".</field>
...
/// <field name="selectedValue" type="Object">Gets or sets the value of the @see:selectedItem obtained using
/// the @see:selectedValuePath.</field>
...
/// <param name="index" type="Number" optional="false">The index of the item in the @see:itemsSource.</param>
/// <returns type="String"></returns>
}
...
wijmo.input.ListBox.prototype.isItemEnabled = function(index) {
/// <summary>Gets a value that determines whether the item at a given index is enabled.</summary>
/// <param name="index" type="Number" optional="false">The index of the item in the @see:itemsSource.</param>
}
wijmo.input.ListBox.prototype.showSelection = function(setFocus) {
/// <summary>Highlights the selected item and scrolls it into view.</summary>
/// <param name="setFocus" type="Boolean" optional="true">Whether to set the focus to the list after scrolling
/// the selected item into view.</param>
}
wijmo.input.ListBox.prototype.loadList = function() {
/// <summary>Loads the list with items from the current @see:itemsSource.</summary>
}
...
wijmo.input.ListBox.prototype.indexOf = function(e) {
/// <summary>Gets the data index of an element within the list.</summary>
/// <param name="e" type="HTMLElement" optional="false">Element to search for.</param>
/// <returns type="Number">The index of the element in the list, or -1 if
/// the element is not a member of the list.</returns>
}
...
wijmo.input.ListBox.prototype.refresh = function(fullUpdate) {
/// <summary>Refreshes the control.</summary>
/// <param name="fullUpdate" type="Boolean" optional="true">Whether to update the control layout as well as the content.</param>
}
wijmo.input.ListBox._wjDict = _wjMerge(wijmo.Control._wjDict, {itemsSource:2,collectionView:2,showGroups:2,isContentHtml:2,itemFormatter:2,displayMemberPath:2,selectedValuePath:2,checkedMemberPath:2,itemRole:2,selectedIndex:2,selectedItem:2,selectedValue:2,maxHeight:2,checkedItems:2,selectedIndexChanged:1,itemsChanged:1,loadingItems:1,loadedItems:1,itemChecked:1,checkedItemsChanged:1,formatItem:1});
wijmo.input.ListBox._wjClass = true;
wijmo.input.FormatItemEventArgs = function(index, data, item) {
/// <summary>Initializes a new instance of the @see:FormatItemEventArgs class.</summary>
/// <param name="index" type="Number" optional="false">Index of the item being formatted in the source @see:ICollectionView, or -1 if the item is a group header.</param>
/// <param name="data" type="Object" optional="false">Data item being formatted, or a @see:CollectionViewGroup object if the item is a group header.</param>
...
/// @see:ComboBox.collectionView to null.</field>
/// <field name="collectionView" type="wijmo.collections.ICollectionView">Gets the @see:ICollectionView object used as the item source.</field>
/// <field name="showGroups" type="Boolean">Gets or sets a value that determines whether the drop-down @see:ListBox
...
/// <field name="displayMemberPath" type="String">Gets or sets the name of the property to use as the visual
/// representation of the items.</field>
/// <field name="headerPath" type="String">Gets or sets the name of a property to use for getting the value
...
/// could show additional detail.</field>
/// <field name="selectedValuePath" type="String">Gets or sets the name of the property used to get the
/// @see:selectedValue from the @see:selectedItem.</field>
...
/// 
/// The default value for this property is <b>false</b>.</field>
/// <field name="itemFormatter" type="Function">Gets or sets a function used to customize the values shown in
/// the drop-down list.
/// The function takes two arguments, the item index and the default
/// text or html, and returns the new text or html to display.
/// 
...
/// <field name="selectedIndex" type="Number">Gets or sets the index of the currently selected item in
/// the drop-down list.</field>
/// <field name="selectedItem" type="Object">Gets or sets the item that is currently selected in
/// the drop-down list.</field>
/// <field name="selectedValue" type="Object">Gets or sets the value of the @see:selectedItem, obtained
/// using the @see:selectedValuePath.</field>
...
/// to true on the @see:AutoComplete control.</field>
...
wijmo.input.ComboBox.prototype.onItemsSourceChanged = function(e) {
/// <summary>Raises the @see:itemsSourceChanged event.</summary>
/// <param name="e" type="wijmo.EventArgs" optional="true"></param>
}
...
wijmo.input.ComboBox._wjDict = _wjMerge(wijmo.input.DropDown._wjDict, {itemsSource:2,collectionView:2,showGroups:2,displayMemberPath:2,headerPath:2,selectedValuePath:2,isContentHtml:2,itemFormatter:2,formatItem:2,selectedIndex:2,selectedItem:2,selectedValue:2,isEditable:2,maxDropDownHeight:2,maxDropDownWidth:2,listBox:2,itemsSourceChanged:1,selectedIndexChanged:1});
...
/// <field name="minLength" type="Number">Gets or sets the minimum input length to trigger auto-complete suggestions.
/// 
/// The default value for this property is <b>2</b>.</field>
/// <field name="maxItems" type="Number">Gets or sets the maximum number of items to display in the drop-down list.
/// 
/// The default value for this property is <b>6</b>.</field>
...
/// 
/// The default value for this property is <b>500</b> milliseconds.</field>
...
/// <field name="subItemsPath" type="String">Gets or sets the name of the property that contains an array with items
/// to be displayed in a sub-menu.</field>
/// <field name="openOnHover" type="Boolean">Gets or sets a value that determines whether the menu (and any sub-menus)
...
wijmo.input.Menu._wjDict = _wjMerge(wijmo.input.ComboBox._wjDict, {header:2,command:2,commandPath:2,commandParameterPath:2,subItemsPath:2,openOnHover:2,isButton:2,owner:2,itemClicked:1});
...
/// <field name="showSelectAllCheckbox" type="Boolean">Gets or sets whether the control should display a "Select All" checkbox
/// above the items to select or de-select all items.
/// 
/// The default value for this property is <b>false</b>.</field>
/// <field name="selectAllLabel" type="String">Gets or sets the string to be used as a label for the "Select All"
...
/// to show a localized version of the string "Select All".</field>
...
/// <field name="headerFormatter" type="Function">Gets or sets a function that gets the text displayed in the control
/// header.
/// 
...
wijmo.input.MultiSelect._wjDict = _wjMerge(wijmo.input.ComboBox._wjDict, {showSelectAllCheckbox:2,selectAllLabel:2,checkedMemberPath:2,maxHeaderItems:2,headerFormat:2,headerFormatter:2,checkedItems:2,checkedItemsChanged:1});
...
/// <field name="showDropDownButton" type="Boolean">Overridden to prevent the control from showing the drop-down button.</field>
...
/// 
/// The default value for this property is <b>true</b>.</field>
/// <field name="removeOnHide" type="Boolean">Gets or sets a value that determines whether the @see:Popup element
...
/// 
/// The default value for this property is <b>false</b>.</field>
/// <field name="isDraggable" type="Boolean">Gets or sets a value that determines whether the popup can be dragged
...
/// 
/// The default value for this property is <b>false</b>.</field>
/// <field name="dialogResult" type="Object">Gets or sets a value used as a return value for the @see:Popup after
/// it is hidden.
/// 
...
/// method to provide a result value to callers.</field>
...
wijmo.input.Popup._wjDict = _wjMerge(wijmo.Control._wjDict, {owner:2,content:2,showTrigger:2,hideTrigger:2,fadeIn:2,fadeOut:2,removeOnHide:2,modal:2,isDraggable:2,dialogResult:2,dialogResultEnter:2,isVisible:2,showing:1,shown:1,hiding:1,hidden:1});
...
/// <field name="value" type="Date">Gets or sets the current date.
/// 
/// The default value for this property is the current date.</field>
/// <field name="text" type="String">Gets or sets the text shown on the control.</field>
/// <field name="selectionMode" type="wijmo.input.DateSelectionMode">Gets or sets a value that indicates whether users can select
...
/// 
/// The default value for this property is <b>true</b>.</field>
/// <field name="showYearPicker" type="Boolean">Gets or sets a value that determines whether the drop-down
...
wijmo.input.InputDate._wjDict = _wjMerge(wijmo.input.DropDown._wjDict, {value:2,text:2,selectionMode:2,min:2,max:2,repeatButtons:2,showYearPicker:2,format:2,mask:2,calendar:2,inputElement:2,inputType:2,itemValidator:2,itemFormatter:2,valueChanged:1});
...
/// <field name="isRequired" type="Boolean">Gets or sets a value indicating whether the control value must be
...
/// 
/// The default value for this property is <b>true</b>.</field>
/// <field name="repeatButtons" type="Boolean">Gets or sets a value that determines whether the spinner buttons
/// should act as repeat buttons, firing repeatedly as the button
/// remains pressed.
/// 
/// The default value for this property is <b>true</b>.</field>
...
wijmo.input.InputNumber.prototype.clamp = function(value) {
/// <summary>Returns a value within the range defined by the @see:min and @see:max
/// properties.</summary>
/// <param name="value" type="Number" optional="false">Value to clamp.</param>
/// <returns type="Number"></returns>
}
...
wijmo.input.InputNumber._wjDict = _wjMerge(wijmo.Control._wjDict, {inputElement:2,inputType:2,value:2,isRequired:2,isReadOnly:2,min:2,max:2,step:2,format:2,text:2,placeholder:2,showSpinner:2,repeatButtons:2,textChanged:1,valueChanged:1});
...
wijmo.input.InputMask._wjDict = _wjMerge(wijmo.Control._wjDict, {inputElement:2,value:2,rawValue:2,mask:2,promptChar:2,placeholder:2,maskFull:2,isRequired:2,isReadOnly:2,valueChanged:1});
...
/// <field name="count" type="Number">Gets the total number of series to render.</field>
...
/// 
/// The default value for this property is <b>SelectionMode.None</b>.</field>
...
/// <summary>Saves the chart to an image file.
/// 
/// NOTE: This method does not work in IE browsers. If you require IE support,
/// add the <code>wijmo.chart.render</code> module to the page.</summary>
...
/// <summary>Saves the chart to an image data url.
/// 
/// NOTE: This method does not work in IE browsers. If you require IE support,
/// add the <code>wijmo.chart.render</code> module to the page.</summary>
...
wijmo.chart.FlexChartBase.prototype.pageToControl = function(pt, y) {
/// <summary>Converts page coordinates to control coordinates.</summary>
/// <param name="pt" type="Object" optional="false">The point of page coordinates or x value
///              of page coordinates.</param>
/// <param name="y" type="Number" optional="true">The y value of page coordinates. Its value
///              should be a number, if pt is a number type. However,
///              the y parameter is optional when pt is Point type.</param>
/// <returns type="wijmo.Point"></returns>
}
...
/// 
/// The default value for this property is <b>Position.None</b>.</field>
...
/// <field name="symbolSize" type="Number">Gets or sets the size of the symbols used for all Series objects
/// in this @see:FlexChart.
/// 
/// This property may be overridden by the symbolSize property on
/// each @see:Series object.
/// 
/// The default value for this property is <b>10</b> pixels.</field>
...
/// <field name="chartType" type="wijmo.chart.ChartType">Gets or sets the type of chart to create.
/// 
/// The default value for this property is <b>ChartType.Column</b>.</field>
...
/// 
/// The default value for this property is <b>false</b>.</field>
/// <field name="stacking" type="wijmo.chart.Stacking">Gets or sets a value that determines whether and how the series objects are stacked.
/// 
/// The default value for this property is <b>Stacking.None</b>.</field>
...
/// the chart to calculate the minimum value based on the data.</field>
/// <field name="max" type="Object">Gets or sets the maximum value shown on the axis.
/// 
/// The value can be a number or a Date object (for time-based data).
/// 
/// The default value for this property is <b>null</b>, which causes
/// the chart to calculate the maximum value based on the data.</field>
...
/// <field name="axisLine" type="Boolean">Gets or sets a value indicating whether the axis line is visible.
/// 
/// The default value for this property is <b>true</b>.</field>
/// <field name="labels" type="Boolean">Gets or sets a value indicating whether the axis labels are visible.
/// 
/// The default value for this property is <b>true</b>.</field>
...
/// 'left' and 'right for the X-axis, 'top' and 'bottom' for the Y-axis.</field>
...
/// <field name="overlappingLabels" type="wijmo.chart.OverlappingLabels">Gets or sets a value indicating how to handle overlapping axis labels.
/// 
/// The default value for this property is <b>OverlappingLabels.Auto</b>.</field>
...
/// <field name="labelPadding" type="Number">Gets or sets the label padding, in pixels.
/// 
/// The default value for this property is <b>5</b> pixels.</field>
...
/// <field name="_isUpdating" type="Boolean">Gets a value that indicates whether the control is currently being updated.</field>
...
wijmo.chart.Axis._wjDict = _wjMerge({}, {hostElement:2,actualMin:2,actualMax:2,min:2,max:2,reversed:2,position:2,majorUnit:2,minorUnit:2,name:2,title:2,format:2,majorGrid:2,majorTickMarks:2,minorGrid:2,minorTickMarks:2,axisLine:2,labels:2,labelAlign:2,labelAngle:2,origin:2,overlappingLabels:2,itemsSource:2,binding:2,itemFormatter:2,logBase:2,plotArea:2,labelPadding:2,rangeChanged:1,axisType:2,_isUpdating:2});
...
/// <field name="altStyle" type="Object">Gets or sets the alternate style for the series.
/// 
...
/// series to use the default style.</field>
...
/// Applies to Scatter, LineSymbols, and SplineSymbols chart types.
/// 
/// The default value for this property is <b>Marker.Dot</b>.</field>
...
/// <field name="visibility" type="wijmo.chart.SeriesVisibility">Gets or sets an enumerated value indicating whether and where the series appears.
/// 
/// The default value for this property is <b>SeriesVisibility.Visible</b>.</field>
...
wijmo.chart.SeriesBase._wjDict = _wjMerge({}, {interpolateNulls:2,style:2,altStyle:2,symbolStyle:2,symbolSize:2,symbolMarker:2,binding:2,bindingX:2,name:2,itemsSource:2,collectionView:2,chart:2,hostElement:2,legendElement:2,cssClass:2,visibility:2,axisX:2,axisY:2,rendering:1,rendered:1});
...
/// 
/// The default value for this property is <b>null</b>, which causes the
/// series to use chart type defined by the parent chart.</field>
...
/// <field name="title" type="String">Gets or sets a value that determines the title of the legend.</field>
/// <field name="titleAlign" type="String">Gets or sets a value that determines the align value of the legend.
/// The value should be 'left', 'center' or 'right'.</field>
this._wjClassName = 'wijmo.chart.Legend';
_wjReownEvents(this);
}
wijmo.chart.Legend._wjDict = _wjMerge({}, {position:2,title:2,titleAlign:2});
...
/// <returns type="wijmo.grid.HitTestInfo"></returns>
/// <field name="chart" type="wijmo.chart.FlexChartBase">Gets the @see:FlexChartBase that owns this @see:wijmo.chart.HitTestInfo.</field>
/// <field name="point" type="wijmo.Point">Gets the point, in control coordinates,
/// that this @see:wijmo.chart.HitTestInfo refers to.</field>
...
/// <field name="distance" type="Number">Gets the distance to the closest data point.</field>
...
wijmo.chart.HitTestInfo._wjDict = _wjMerge({}, {chart:2,point:2,series:2,pointIndex:2,chartElement:2,distance:2,item:2,x:2,y:2});
...
wijmo.chart.analytics.ErrorBar.prototype.getPlotElement = function(pointIndex) {
/// <summary>Gets the plot element that corresponds to the specified point index.</summary>
/// <param name="pointIndex" type="Number" optional="false">The index of the data point.</param>
/// <returns type="Object"></returns>
}
...
/// <field name="selectionMode" type="wijmo.grid.SelectionMode">The selectionMode doesn't work in TreeMap control.</field>
/// <field name="tooltip" type="wijmo.chart.ChartTooltip">Gets the chart's @see:Tooltip.</field>
...
/// If a treemap has more levels than this value, user has to move up and down.</field>
/// <field name="palette" type="String[]">Gets or sets an array of default colors to be used in a treemap.
/// 
...
wijmo.chart.hierarchical.TreeMap._wjDict = _wjMerge(wijmo.chart.FlexChartBase._wjDict, {selectionMode:2,tooltip:2,binding:2,type:2,bindingName:2,dataLabel:2,childItemsPath:2,maxDepth:2,palette:2});
...
/// <field name="showText" type="wijmo.gauge.ShowText">Gets or sets the @see:ShowText values to display as text in the gauge.
/// 
/// The default value for this property is <b>ShowText.All</b> for @see:RadialGauge
/// controls, and to <b>ShowText.None</b> for @see:LinearGauge controls.</field>
/// <field name="showTicks" type="Boolean">Gets or sets a property that determines whether the gauge should
...
/// <field name="thumbSize" type="Number">Gets or sets the size of the element that shows the gauge's current value,
/// in pixels.</field>
/// <field name="showRanges" type="Boolean">Gets or sets a value that indicates whether the gauge displays the ranges
...
/// 
/// The default value for this property is <b>true</b>.</field>
/// <field name="stackRanges" type="Boolean">Gets or sets a value that determines whether the ranges contained in
...
/// and to be displayed side-by-side.</field>
/// <field name="hasShadow" type="Boolean">Gets or sets a value that indicates whether the gauge displays
/// a shadow effect.
/// 
/// The default value for this property is <b>true</b>.</field>
/// <field name="isAnimated" type="Boolean">Gets or sets a value that determines whether the @see:Gauge
...
wijmo.gauge.Gauge._wjDict = _wjMerge(wijmo.Control._wjDict, {value:2,min:2,max:2,origin:2,isReadOnly:2,step:2,format:2,getText:2,thickness:2,face:2,pointer:2,showText:2,showTicks:2,tickSpacing:2,thumbSize:2,showRanges:2,stackRanges:2,hasShadow:2,isAnimated:2,ranges:2,valueChanged:1});
...
/// <field name="direction" type="wijmo.gauge.GaugeDirection">Gets or sets the direction in which the gauge is filled.
/// 
/// The default value for this property is <b>GaugeDirection.Right</b>.</field>
...
/// <field name="startAngle" type="Number">Gets or sets the starting angle for the gauge.
/// 
/// Angles are measured in degrees, clockwise, starting from the
/// 9 o'clock position.
/// 
/// The default value for this property is <b>0</b>.</field>
/// <field name="sweepAngle" type="Number">Gets or sets the sweep angle for the gauge.
/// 
/// Angles are measured in degrees, clockwise,
/// starting from the 9 o'clock position.
/// 
/// The default value for this property is <b>180</b>.</field>
/// <field name="autoScale" type="Boolean">Gets or sets a value that indicates whether the gauge automatically
/// scales to fill the host element.
/// 
/// The default value for this property is <b>true</b>.</field>
/// <field name="clientSize" type="wijmo.Size">Gets the size of the gauge's client area, taking into account the
/// @see:autoScale, padding, borders, and margins.</field>
...
wijmo.gauge.RadialGauge._wjDict = _wjMerge(wijmo.gauge.Gauge._wjDict, {startAngle:2,sweepAngle:2,autoScale:2,clientSize:2});
...
wijmo.gauge.Range = function(options) {
/// <summary>Initializes a new instance of the @see:Range class.</summary>
/// <param name="options" type="String" optional="true">Initialization options for the @see:Range or a string
/// containing the @see:Range name.</param>
...
/// <field name="expand" type="String">Gets or sets a string that specifies whether related entities should
...
///   expand: 'Orders'
/// });</pre></field>
/// <field name="jsonReviver" type="Function">Gets or sets a custom reviver function to use when parsing JSON
...
/// for the
/// <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/JSON/parse" target="_blank">JSON.parse method</a>.</field>
...
/// <field name="showDatesAsGmt" type="Object">Gets or sets a value that determines whether dates should be adjusted
/// to look like GMT rather than local dates.</field>
...
/// 
/// The default value for this property is <b>true</b>.</field>
/// <field name="filterOnServer" type="Boolean">Gets or sets a value that determines whether filtering should be
/// performed on the server or on the client.
/// 
...
wijmo.xlsx.useJSZip = function(jszip) {
/// <summary>Defines a reference to JSZip module that will be used by the Wijmo xlsx export modules.
/// 
...
/// </pre></summary>
/// <param name="jszip" type="Object" optional="false">Reference to the JSZip constructor function.</param>
}
...
/// <field name="colorThemes" type="String[]">Gets the color of the workbook themes.</field>
...
wijmo.xlsx.Workbook._wjDict = _wjMerge({}, {sheets:2,styles:2,definedNames:2,colorThemes:2,reservedContent:2});
...
/// <field name="tables" type="wijmo.xlsx.WorkbookTable[]">Gets the name of tables refered in this worksheet.</field>
this._wjClassName = 'wijmo.xlsx.WorkSheet';
_wjReownEvents(this);
}
wijmo.xlsx.WorkSheet._wjDict = _wjMerge({}, {columns:2,rows:2,tables:2});
...
/// <field name="link" type="String">Gets or sets the hyperlink of cell.</field>
/// <field name="textRuns" type="wijmo.xlsx.WorkbookTextRun[]">Gets or sets the text runs represent the rich text of cell.</field>
...
wijmo.xlsx.WorkbookTable = function() {
/// <summary>Initializes a new instance of the @see:WorkbookTable class.</summary>
/// <returns type="wijmo.xlsx.WorkbookTable"></returns>
/// <field name="name" type="String">The name of the table.  It is used to reference the table programmatically.</field>
/// <field name="range" type="String">The range on the relevant sheet that the table occupies expressed using A1 style referencing. i.e. "A1:D4".
/// The reference shall include the totals row if it is shown.</field>
/// <field name="showHeaderRow" type="Boolean">Indicates whether show the header row for the table.</field>
/// <field name="showTotalRow" type="Boolean">Indicates whether show the total row for the table.</field>
/// <field name="showBandedColumns" type="Boolean">Indicating whether banded column formatting is applied.</field>
/// <field name="style" type="wijmo.xlsx.WorkbookTableStyle">The table style to use with the table.</field>
/// <field name="showBandedRows" type="Boolean">Indicating whether banded row formatting is applied.</field>
/// <field name="alterFirstColumn" type="Boolean">Indicating whether the first column in the table should have the style applied.</field>
/// <field name="alterLastColumn" type="Boolean">Indicating whether the last column in the table should have the style applied.</field>
/// <field name="columns" type="wijmo.xlsx.WorkbookTableColumn[]">The columns of the table.</field>
this._wjClassName = 'wijmo.xlsx.WorkbookTable';
_wjReownEvents(this);
}
wijmo.xlsx.WorkbookTable._wjDict = _wjMerge({}, {columns:2});
wijmo.xlsx.WorkbookTable._wjClass = true;
wijmo.xlsx.WorkbookTableColumn = function() {
/// <summary>Initializes a new instance of the @see:WorkbookTableColumn class.</summary>
/// <returns type="wijmo.xlsx.WorkbookTableColumn"></returns>
/// <field name="name" type="String">The name of the table column. It is referenced through functions.</field>
/// <field name="totalRowLabel" type="String">The string to show in the totals row cell for the column.</field>
/// <field name="totalRowFunction" type="String">The function to show in the totals row cell for this column.</field>
/// <field name="showFilterButton" type="Boolean">Indicating whether show filter button for the column.</field>
this._wjClassName = 'wijmo.xlsx.WorkbookTableColumn';
_wjReownEvents(this);
}
wijmo.xlsx.WorkbookTableColumn._wjDict = _wjMerge({}, {});
wijmo.xlsx.WorkbookTableColumn._wjClass = true;
wijmo.xlsx.WorkbookTableStyle = function() {
/// <summary>Initializes a new instance of the @see:WorkbookTableStyle class.</summary>
/// <returns type="wijmo.xlsx.WorkbookTableStyle"></returns>
/// <field name="name" type="String">The name of the table style.</field>
/// <field name="wholeTableStyle" type="wijmo.xlsx.WorkbookTableCommonStyle">The whole table style.</field>
/// <field name="firstBandedColumnStyle" type="wijmo.xlsx.WorkbookTableBandedStyle">The first column stripe style.</field>
/// <field name="secondBandedColumnStyle" type="wijmo.xlsx.WorkbookTableBandedStyle">The second column stripe style.</field>
/// <field name="firstBandedRowStyle" type="wijmo.xlsx.WorkbookTableBandedStyle">The first row stripe style.</field>
/// <field name="secondBandedRowStyle" type="wijmo.xlsx.WorkbookTableBandedStyle">The second row stripe style.</field>
/// <field name="firstColumnStyle" type="wijmo.xlsx.WorkbookTableCommonStyle">The first column style.</field>
/// <field name="lastColumnStyle" type="wijmo.xlsx.WorkbookTableCommonStyle">The last column style.</field>
/// <field name="headerRowStyle" type="wijmo.xlsx.WorkbookTableCommonStyle">The header row style.</field>
/// <field name="totalRowStyle" type="wijmo.xlsx.WorkbookTableCommonStyle">The total row style.</field>
/// <field name="firstHeaderCellStyle" type="wijmo.xlsx.WorkbookTableCommonStyle">The first cell style in the header row.</field>
/// <field name="lastHeaderCellStyle" type="wijmo.xlsx.WorkbookTableCommonStyle">The last cell style in the header row.</field>
/// <field name="firstTotalCellStyle" type="wijmo.xlsx.WorkbookTableCommonStyle">The first cell style in the total row.</field>
/// <field name="lastTotalCellStyle" type="wijmo.xlsx.WorkbookTableCommonStyle">The last cell style in the total row.</field>
this._wjClassName = 'wijmo.xlsx.WorkbookTableStyle';
_wjReownEvents(this);
}
wijmo.xlsx.WorkbookTableStyle._wjDict = _wjMerge({}, {});
wijmo.xlsx.WorkbookTableStyle._wjClass = true;
wijmo.xlsx.WorkbookTableCommonStyle = function() {
/// <summary>Initializes a new instance of the @see:WorkbookTableCommonStyle class.</summary>
/// <returns type="wijmo.xlsx.WorkbookTableCommonStyle"></returns>
/// <field name="borders" type="wijmo.xlsx.WorkbookTableBorder">Table borders setting.</field>
this._wjClassName = 'wijmo.xlsx.WorkbookTableCommonStyle';
_wjReownEvents(this);
}
wijmo.xlsx.WorkbookTableCommonStyle.prototype = new wijmo.xlsx.WorkbookStyle();
wijmo.xlsx.WorkbookTableCommonStyle._wjDict = _wjMerge(wijmo.xlsx.WorkbookStyle._wjDict, {});
wijmo.xlsx.WorkbookTableCommonStyle._wjClass = true;
wijmo.xlsx.WorkbookTableBandedStyle = function() {
/// <summary>Initializes a new instance of the @see:WorkbookTableBandedStyle class.</summary>
/// <returns type="wijmo.xlsx.WorkbookTableBandedStyle"></returns>
/// <field name="size" type="Number">Number of rows or columns in a single band of striping.</field>
this._wjClassName = 'wijmo.xlsx.WorkbookTableBandedStyle';
_wjReownEvents(this);
}
wijmo.xlsx.WorkbookTableBandedStyle.prototype = new wijmo.xlsx.WorkbookTableCommonStyle();
wijmo.xlsx.WorkbookTableBandedStyle._wjDict = _wjMerge(wijmo.xlsx.WorkbookTableCommonStyle._wjDict, {});
wijmo.xlsx.WorkbookTableBandedStyle._wjClass = true;
wijmo.xlsx.WorkbookTableBorder = function() {
/// <summary>Initializes a new instance of the @see:WorkbookTableBorder class.</summary>
/// <returns type="wijmo.xlsx.WorkbookTableBorder"></returns>
/// <field name="vertical" type="wijmo.xlsx.WorkbookBorderSetting">Vertical border setting.</field>
/// <field name="horizontal" type="wijmo.xlsx.WorkbookBorderSetting">Horizontal border setting.</field>
this._wjClassName = 'wijmo.xlsx.WorkbookTableBorder';
_wjReownEvents(this);
}
wijmo.xlsx.WorkbookTableBorder.prototype = new wijmo.xlsx.WorkbookBorder();
wijmo.xlsx.WorkbookTableBorder._wjDict = _wjMerge(wijmo.xlsx.WorkbookBorder._wjDict, {});
wijmo.xlsx.WorkbookTableBorder._wjClass = true;
wijmo.xlsx.WorkbookTextRun = function() {
/// <summary>Initializes a new instance of the @see:WorkbookTextRun class.</summary>
/// <returns type="wijmo.xlsx.WorkbookTextRun"></returns>
/// <field name="font" type="wijmo.xlsx.WorkbookFont">Gets or sets the font of the text run.</field>
/// <field name="text" type="String">Gets or sets the text of the text run.</field>
this._wjClassName = 'wijmo.xlsx.WorkbookTextRun';
_wjReownEvents(this);
}
wijmo.xlsx.WorkbookTextRun._wjDict = _wjMerge({}, {});
wijmo.xlsx.WorkbookTextRun._wjClass = true;
wijmo.xlsx.HAlign = {
...
/// <field name="document" type="wijmo.pdf.PdfDocument">Gets the document object.</field>
...
wijmo.pdf.PdfPageArea.prototype.drawImage = function(src, x, y, options) {
...
/// <param name="src" type="Object" optional="false">A string containing the URL to get the image from or the data URI containing a base64 encoded image or a @see:wijmo.pdf.IPdfImage object.</param>
...
/// <param name="options" type="wijmo.pdf.IPdfTextMeasurementSettings" optional="true">Determines the text drawing options.</param>
/// <returns type="wijmo.pdf.IPdfTextMeasurementInfo">A @see:IPdfTextMeasurementInfo object determines the measurement information.</returns>
}
...
wijmo.pdf.PdfPageArea.prototype.openImage = function(url) {
/// <summary>Opens an image in JPG or PNG format.</summary>
...
/// <returns type="wijmo.pdf.IPdfImage">The @see:IPdfImage object containing image data.</returns>
}
...
wijmo.pdf.PdfPageArea._wjDict = _wjMerge({}, {x:2,y:2,lineGap:2,height:2,width:2,paths:2,document:2});
...
wijmo.pdf.PdfDocumentEndedEventArgs = function(chunks) {
/// <summary>Initializes a new instance of the @see:PdfDocumentEndedEventArgs class.</summary>
/// <param name="chunks" type="Uint8Array[]" optional="false">An array of chunks.</param>
...
/// <field name="chunks" type="Uint8Array[]">Gets the underlying array of buffers that contains the document data.</field>
this._wjClassName = 'wijmo.pdf.PdfDocumentEndedEventArgs';
_wjReownEvents(this);
}
wijmo.pdf.PdfDocumentEndedEventArgs.prototype = new wijmo.EventArgs();
wijmo.pdf.PdfDocumentEndedEventArgs._wjDict = _wjMerge(wijmo.EventArgs._wjDict, {blob:2,chunks:2});
...
/// <param name="p" type="Object/*_IGridPanel*/" optional="false">@see:GridPanel that contains the range.</param>
/// <param name="rng" type="Object/*_ICellRange*/" optional="false">Range of cells affected by the event.</param>
...
wijmo.grid.pdf.PdfFormatItemEventArgs._wjDict = _wjMerge({}, {panel:2,range:2,row:2,col:2,data:2,canvas:2,cell:2,clientRect:2,contentRect:2,style:2,textTop:2});
wijmo.grid.pdf.PdfFormatItemEventArgs._wjClass = true;
wijmo.grid.pdf._FlexGridPdfConverterCore = function() {
/// <summary>Provides a functionality to export the @see:FlexGrid to PDF.</summary>
/// <returns type="wijmo.grid.pdf._FlexGridPdfConverterCore"></returns>
this._wjClassName = 'wijmo.grid.pdf._FlexGridPdfConverterCore';
_wjReownEvents(this);
}
wijmo.grid.pdf._FlexGridPdfConverterCore.draw = function(flex, doc, point, width, height, settings) {
...
/// });
/// </pre></summary>
/// <param name="flex" type="_IFlexGridAdapter" optional="false">The @see:FlexGrid instance to export.</param>
/// <param name="doc" type="wijmo.pdf.PdfDocument" optional="false">The @see:PdfDocument instance to draw in.</param>
/// <param name="point" type="wijmo.Point" optional="true">The position to draw at, in points.</param>
...
/// <param name="settings" type="wijmo.grid.pdf.IFlexGridExportSettings" optional="true">The draw settings.</param>
}
wijmo.grid.pdf._FlexGridPdfConverterCore._wjDict = _wjMerge({}, {});
wijmo.grid.pdf._FlexGridPdfConverterCore._wjClass = true;
wijmo.grid.pdf.FlexGridPdfConverter = function() {
/// <summary>Provides a functionality to export the @see:FlexGrid to PDF.
/// The example below shows how you can use a @see:FlexGridPdfConverter to
/// export a @see:FlexGrid to PDF:
/// @fiddle:equxqkyt</summary>
...
/// });
/// </pre></summary>
/// <param name="flex" type="Object" optional="false">The @see:FlexGrid instance to export.</param>
/// <param name="doc" type="wijmo.pdf.PdfDocument" optional="false">The @see:PdfDocument instance to draw in.</param>
/// <param name="width" type="Number" optional="true">The width of the drawing area in points.</param>
/// <param name="height" type="Number" optional="true">The height of the drawing area in points.</param>
...
wijmo.grid.pdf.PdfWebWorkerExportDoneEventArgs = function(buffer) {
/// <summary>Initializes a new instance of the @see:PdfWebWorkerExportDoneEventArgs class.</summary>
/// <param name="buffer" type="ArrayBuffer" optional="false">An ArrayBuffer.</param>
/// <returns type="wijmo.grid.pdf.PdfWebWorkerExportDoneEventArgs"></returns>
/// <field name="blob" type="Blob">Gets a Blob object that contains the document data.</field>
/// <field name="buffer" type="ArrayBuffer">Gets an ArrayBuffer that contains the document data.</field>
this._wjClassName = 'wijmo.grid.pdf.PdfWebWorkerExportDoneEventArgs';
_wjReownEvents(this);
}
wijmo.grid.pdf.PdfWebWorkerExportDoneEventArgs.prototype = new wijmo.EventArgs();
wijmo.grid.pdf.PdfWebWorkerExportDoneEventArgs._wjDict = _wjMerge(wijmo.EventArgs._wjDict, {blob:2,buffer:2});
wijmo.grid.pdf.PdfWebWorkerExportDoneEventArgs._wjClass = true;
wijmo.grid.pdf.PdfWebWorkerClient = function() {
/// <summary>Represents client-side methods for exporting FlexGrid to PDF/generating PDF, for use with Web Worker.</summary>
/// <returns type="wijmo.grid.pdf.PdfWebWorkerClient"></returns>
this._wjClassName = 'wijmo.grid.pdf.PdfWebWorkerClient';
_wjReownEvents(this);
}
wijmo.grid.pdf.PdfWebWorkerClient.exportGrid = function(worker, grid, fileName, settings, done, progress) {
/// <summary>Exports the @see:FlexGrid to PDF in a background thread.</summary>
/// <param name="worker" type="Worker" optional="false">The Web Worker instance to run the exporting code in.</param>
/// <param name="grid" type="wijmo.grid.FlexGrid" optional="false">The @see:FlexGrid instance to export.</param>
/// <param name="fileName" type="String" optional="false">The name of the file to export.</param>
/// <param name="settings" type="wijmo.grid.pdf.IFlexGridExportSettings" optional="false">The export settings.</param>
/// <param name="done" type="Function" optional="true">An optional callback function to call when exporting is done. The function takes a single parameter, an instance of the @see:PdfWebWorkerExportDoneEventArgs class.</param>
/// <param name="progress" type="Function" optional="true">An optional function that gives feedback about the progress of the export. The function takes a single parameter, a number changing from 0.0 to 1.0,
/// where the value of 0.0 indicates that the operation has just begun and the value of 1.0 indicates that the operation has completed.</param>
}
wijmo.grid.pdf.PdfWebWorkerClient.export = function(worker, settings, done, progress) {
/// <summary>Exports PDF in a background thread.</summary>
/// <param name="worker" type="Worker" optional="false">The Web Worker instance to run the exporting code in.</param>
/// <param name="settings" type="Object" optional="false">An object containing @see:PdfDocument's initialization settings.</param>
/// <param name="done" type="Function" optional="false">The callback function to call when drawing is done. The function takes a single parameter, an instance of the @see:PdfWebWorkerExportDoneEventArgs class.</param>
/// <param name="progress" type="Function" optional="true">An optional function that gives feedback about the progress of the export. The function takes a single parameter, a number changing from 0.0 to 1.0,
/// where the value of 0.0 indicates that the operation has just begun and the value of 1.0 indicates that the operation has completed.</param>
}
wijmo.grid.pdf.PdfWebWorkerClient.addGrid = function(worker, grid, name, settings) {
/// <summary>Adds named FlexGrid with settings, which will be used in a Web Worker to generate a PDF document.
/// This method should be used in conjunction with the @see:PdfWebWorkerClient.export method.</summary>
/// <param name="worker" type="Worker" optional="false">The Web Worker instance to send the data to.</param>
/// <param name="grid" type="wijmo.grid.FlexGrid" optional="false">The grid</param>
/// <param name="name" type="String" optional="false">The name associated with the grid.</param>
/// <param name="settings" type="wijmo.grid.pdf.IFlexGridDrawSettings" optional="false">The draw settings.</param>
}
wijmo.grid.pdf.PdfWebWorkerClient.addImage = function(worker, image, name, settings) {
/// <summary>Adds named image with settings, which will be used in a Web Worker to generate a PDF document.
/// This method should be used in conjunction with the @see:PdfWebWorkerClient.export method.</summary>
/// <param name="worker" type="Worker" optional="false">The Web Worker instance to send the data to.</param>
/// <param name="image" type="String" optional="false">A string containing the URL to get the image from or the data URI containing a base64 encoded image.</param>
/// <param name="name" type="String" optional="false">The name associated with the image.</param>
/// <param name="settings" type="wijmo.pdf.IPdfImageDrawSettings" optional="false">The image drawing settings.</param>
}
wijmo.grid.pdf.PdfWebWorkerClient.addString = function(worker, value, name) {
/// <summary>Adds named string which will be used in a Web Worker code to generate a PDF document.
/// This method should be used in conjunction with the @see:PdfWebWorkerClient.export method.</summary>
/// <param name="worker" type="Worker" optional="false">The Web Worker instance to send the data to.</param>
/// <param name="value" type="String" optional="false">The value.</param>
/// <param name="name" type="String" optional="false">The name associated with the string.</param>
}
wijmo.grid.pdf.PdfWebWorkerClient.serializeGrid = function(grid, settings) {
/// <summary>Serializes the @see:FlexGrid to ArrayBuffer. The serialized data can be send to a Web Worker using the postMessage method.</summary>
/// <param name="grid" type="wijmo.grid.FlexGrid" optional="false">The @see:FlexGrid instance to serialize.</param>
/// <param name="settings" type="wijmo.grid.pdf.IFlexGridExportSettings" optional="true">The export settings used to serialize the grid.</param>
/// <returns type="ArrayBuffer"></returns>
}
wijmo.grid.pdf.PdfWebWorkerClient._wjDict = _wjMerge({}, {});
wijmo.grid.pdf.PdfWebWorkerClient._wjClass = true;
wijmo.grid.pdf.PdfWebWorker = function() {
/// <summary>Represents server-side methods for exporting FlexGrid to PDF/generating PDF, for use with Web Worker.</summary>
/// <returns type="wijmo.grid.pdf.PdfWebWorker"></returns>
this._wjClassName = 'wijmo.grid.pdf.PdfWebWorker';
_wjReownEvents(this);
}
wijmo.grid.pdf.PdfWebWorker.initExportGrid = function() {
/// <summary>Performs the export started in a UI thread by calling the @see:PdfWebWorkerClient.exportGrid method.</summary>
}
wijmo.grid.pdf.PdfWebWorker.initExport = function(draw) {
/// <summary>Performs the PDF document generation started in a UI thread by calling the @see:PdfWebWorkerClient.export method.</summary>
/// <param name="draw" type="Function" optional="false">The callback function to draw PDF.
...
wijmo.grid.pdf.PdfWebWorker.sendExportProgress = function(value) {
/// <summary>Sends the progress value to a client, where it will be handled by the @see:PdfWebWorkerClient.export's progress callback function.
/// Should be used in conjunction with the @see:PdfWebWorkerClient.export method to inform client about the progress of the export.</summary>
/// <param name="value" type="Number" optional="false">The progress value, in the range of [0.0..1.0].</param>
}
wijmo.grid.pdf.PdfWebWorker.deserializeGrid = function(data, settings) {
/// <summary>Deserializes the @see:FlexGrid from ArrayBuffer to its internal representation that can be used in a Web Worker and passed to the @see:FlexGridPdfConverter.draw and @see:FlexGridPdfConverter.drawToPosition methods.</summary>
/// <param name="data" type="ArrayBuffer" optional="false">The data to deserialize.</param>
/// <param name="settings" type="wijmo.grid.pdf.IFlexGridDrawSettings" optional="true">The draw settings used to deserialize the grid.</param>
/// <returns type="Object"></returns>
}
wijmo.grid.pdf.PdfWebWorker._wjDict = _wjMerge({}, {});
wijmo.grid.pdf.PdfWebWorker._wjClass = true;
...
/// <field name="isContentHtml" type="Boolean">Gets or sets a value indicating whether items are bound to plain text or HTML.
/// 
/// The default value for this property is <b>false</b>.</field>
...
/// collapsing nodes that are not in use helps keep the UI clear.</field>
...
this.itemsSourceChanged = new wijmo.Event('wijmo.EventArgs');
this.loadingItems = new wijmo.Event('wijmo.CancelEventArgs');
this.loadedItems = new wijmo.Event('wijmo.EventArgs');
this.itemClicked = new wijmo.Event('wijmo.EventArgs');
...
wijmo.nav.TreeView.prototype.addChildNode = function(index, dataItem) {
/// <summary>Adds a child node at a specific position.</summary>
/// <param name="index" type="Number" optional="false">Index of the new child node.</param>
/// <param name="dataItem" type="Object" optional="false">Data item used to create the new node.</param>
/// <returns type="wijmo.nav.TreeNode">The @see:TreeNode that was added.</returns>
}
...
wijmo.nav.TreeView.prototype.loadTree = function(preserveOutlineState) {
/// <summary>Loads the tree using data from the current @see:itemsSource.</summary>
/// <param name="preserveOutlineState" type="Boolean" optional="true">Whether to preserve the outline state when loading the
/// tree data. Defaults to false.</param>
}
...
wijmo.nav.TreeView.prototype.refresh = function(fullUpdate) {
...
/// <field name="element" type="HTMLElement">Gets the HTML element that represents this node on the @see:TreeView.</field>
...
/// <field name="itemsSource" type="Object[]">Gets the array that contains the items for this @see:TreeNode.
/// 
/// This property is read-only. It returns an array that is a
/// member of the parent @see:TreeView's @see:TreeView.itemsSource array.</field>
...
/// <summary>Gets a reference to the previous sibling node in the view.</summary>
/// <returns type="wijmo.nav.TreeNode"></returns>
}
...
wijmo.nav.TreeNode.prototype.remove = function() {
/// <summary>Removes this @see:TreeNode from a @see:TreeView.</summary>
}
wijmo.nav.TreeNode.prototype.addChildNode = function(index, dataItem) {
/// <summary>Adds a child node at a specific position.</summary>
/// <param name="index" type="Number" optional="false">Index of the new child node.</param>
/// <param name="dataItem" type="Object" optional="false">Data item used to create the new node.</param>
/// <returns type="wijmo.nav.TreeNode">The @see:TreeNode that was added.</returns>
}
wijmo.nav.TreeNode.prototype.refresh = function(dataItem) {
/// <summary>Refreshes a node to reflect data changes.</summary>
/// <param name="dataItem" type="Object" optional="true">New node data. This parameter is optional.
/// If not provided, the node will be refreshed based on its
/// original data item (which presumably has been updated).</param>
}
wijmo.nav.TreeNode.prototype.move = function(refNode, position) {
/// <summary>Moves this @see:TreeNode to a new position on the @see:TreeView.</summary>
/// <param name="refNode" type="Object" optional="false">Reference @see:TreeNode that defines the location
...
wijmo.nav.TreeNode._wjDict = _wjMerge({}, {dataItem:2,element:2,treeView:2,index:2,parentNode:2,level:2,hasChildren:2,hasPendingChildren:2,nodes:2,checkBox:2,isCollapsed:2,isChecked:2,isDisabled:2,itemsSource:2});
...
wijmo.nav.TabPanel = function(element, options, keepChildren) {
/// <summary>Initializes a new instance of the @see:TabPanel class.</summary>
/// <param name="element" type="Object" optional="false">The DOM element that hosts the control, or a CSS selector for the host element (e.g. '#theCtrl').</param>
/// <param name="options" type="Object" optional="true">The JavaScript object containing initialization data for the control.</param>
/// <param name="keepChildren" type="Boolean" optional="true">Whether to keep child elements. If set to true, the caller becomes responsible for
/// populating the @see:tabs array based on the DOM).</param>
/// <returns type="wijmo.nav.TabPanel"></returns>
/// <field name="tabs" type="wijmo.collections.ObservableArray">Gets an array of @see:Tab objects whose @see:Tab.header and
/// @see:Tab.pane properties determine the content of the
/// @see:TabPanel control.</field>
/// <field name="selectedIndex" type="Number">Gets or sets the index of the currently selected (active) tab.</field>
/// <field name="selectedTab" type="wijmo.nav.Tab">Gets or sets the @see:Tab object that is currently selected.</field>
/// <field name="isAnimated" type="Boolean">Gets or sets a value that determines whether tab changes should be animated
/// with a fade-in effect.
/// 
/// The default value for this property is <b>true</b>.</field>
/// <field name="autoSwitch" type="Boolean">Gets or sets a value that determines whether the control should switch
...
/// and
/// <a href="http://simplyaccessible.com/article/danger-aria-tabs/" target="_blank">SimplyAccessible</a> articles.</field>
/// <field name="selectedIndexChanged" type="wijmo.Event">Occurs when the value of the @see:selectedIndex property changes.</field>
this._wjClassName = 'wijmo.nav.TabPanel';
this.selectedIndexChanged = new wijmo.Event('wijmo.EventArgs');
_wjReownEvents(this);
}
wijmo.nav.TabPanel.prototype = new wijmo.Control();
wijmo.nav.TabPanel.prototype.getTab = function(id) {
/// <summary>Gets a @see:Tab by id or by header content.</summary>
/// <param name="id" type="String" optional="false">Id of the @see:Tab to retrieve.</param>
/// <returns type="wijmo.nav.Tab"></returns>
}
wijmo.nav.TabPanel.prototype.onSelectedIndexChanged = function(e) {
/// <summary>Raises the @see:selectedIndexChanged event.</summary>
/// <param name="e" type="wijmo.EventArgs" optional="true"></param>
}
wijmo.nav.TabPanel.controlTemplate = undefined;
intellisense.annotate(wijmo.nav.TabPanel, {
// Gets or sets the template used to instantiate @see:TabPanel controls.
controlTemplate: undefined
});
wijmo.nav.TabPanel._wjDict = _wjMerge(wijmo.Control._wjDict, {tabs:2,selectedIndex:2,selectedTab:2,isAnimated:2,autoSwitch:2,selectedIndexChanged:1});
wijmo.nav.TabPanel._wjClass = true;
wijmo.nav.Tab = function(header, pane) {
/// <summary>Initializes a new instance of the @see:Tab class.</summary>
/// <param name="header" type="Object" optional="false">Element or CSS selector for the element that contains the Tab header.</param>
/// <param name="pane" type="Object" optional="false">Element or CSS selector for the element that contains the Tab content.</param>
/// <returns type="wijmo.nav.Tab"></returns>
/// <field name="tabPanel" type="wijmo.nav.TabPanel">Gets a reference to the @see:TabPanel that contains this Tab.</field>
/// <field name="header" type="HTMLElement">Gets the tab's header element.</field>
/// <field name="pane" type="HTMLElement">Gets the tab's content element.</field>
/// <field name="isDisabled" type="Boolean">Gets or sets a value that determines whether this @see:Tab is disabled.</field>
/// <field name="isVisible" type="Boolean">Gets or sets a value that determines whether this @see:Tab is visible.</field>
this._wjClassName = 'wijmo.nav.Tab';
_wjReownEvents(this);
}
wijmo.nav.Tab._wjDict = _wjMerge({}, {tabPanel:2,header:2,pane:2,isDisabled:2,isVisible:2});
wijmo.nav.Tab._wjClass = true;
...
/// <field name="filter" type="wijmo.grid.sheet.FlexSheetFilter">Gets the @see:FlexSheetFilter instance that controls <b>FlexSheet</b> filtering.</field>
/// <field name="showFilterIcons" type="Boolean">Gets or sets the visiblity of the filter icon.</field>
/// <field name="definedNames" type="wijmo.collections.ObservableArray">Gets an array the @see:IDefinedName objects representing named ranges/expressions
/// defined in the <b>FlexSheet</b>.</field>
/// <field name="enableDragDrop" type="Boolean">Gets or sets the value to indicates whether enable drag and drop rows or columns in FlexSheet.</field>
/// <field name="enableFormulas" type="Boolean">Gets or sets the value to indicates whether enable formulas in FlexSheet.</field>
...
this.prepareChangingRow = new wijmo.Event('wijmo.grid.sheet.RowColumnChangedEventArgs');
this.prepareChangingColumn = new wijmo.Event('wijmo.grid.sheet.RowColumnChangedEventArgs');
...
wijmo.grid.sheet.FlexSheet.prototype.onPrepareChangingRow = function(e) {
...
wijmo.grid.sheet.FlexSheet.prototype.onPrepareChangingColumn = function(e) {
...
wijmo.grid.sheet.FlexSheet.prototype.setCellData = function(r, c, value, coerce, invalidate) {
/// <summary>Overrides the setCellData function of the base class.</summary>
/// <param name="r" type="Number" optional="false">Index of the row that contains the cell.</param>
/// <param name="c" type="Object" optional="false">Index, name, or binding of the column that contains the cell.</param>
/// <param name="value" type="Object" optional="false">Value to store in the cell.</param>
/// <param name="coerce" type="Boolean" optional="true">Whether to change the value automatically to match the column's data type.</param>
/// <param name="invalidate" type="Boolean" optional="true">Whether to invalidate the FlexSheet to show the change.</param>
/// <returns type="Boolean">True if the value was stored successfully, false otherwise.</returns>
}
...
wijmo.grid.sheet.FlexSheet.prototype.evaluate = function(formula, format, sheet, getPrimitiveResult) {
...
/// <param name="getPrimitiveResult" type="Boolean" optional="true">Indicates whether need convert the non-primitive result to primitive type.</param>
/// <returns type="Object"></returns>
}
...
wijmo.grid.sheet.FlexSheet.prototype.save = function(fileName, options) {
...
/// <param name="options" type="wijmo.grid.sheet.IFlexSheetXlsxOptions" optional="true">@see:IFlexSheetXlsxOptions object specifying the save options.</param>
/// <returns type="wijmo.xlsx.Workbook">A workbook instance containing the generated xlsx file content.</returns>
}
wijmo.grid.sheet.FlexSheet.prototype.saveAsync = function(fileName, onSaved, onError, options) {
...
/// <param name="onLoaded" type="(workbook: wijmo.xlsx.Workbook)" optional="true">This callback provides access to the loaded workbook instance.
/// Since this method is asynchronous, users cannot get the loaded workbook
/// instance immediately.
/// This callback has a single parameter, the loaded workbook instance.</param>
/// <param name="onError" type="(reason?: any)" optional="true">This callback catches errors when loading workbooks.
...
wijmo.grid.sheet.FlexSheet.prototype.getBuiltInTableStyle = function(styleName) {
/// <summary>Get the built-in table style via its name.</summary>
/// <param name="styleName" type="String" optional="false">The name of the built-in table style.</param>
/// <returns type="wijmo.grid.sheet.TableStyle"></returns>
}
...
wijmo.grid.sheet.FlexSheet._wjDict = _wjMerge(wijmo.grid.FlexGrid._wjDict, {sheets:2,selectedSheetIndex:2,selectedSheet:2,isFunctionListOpen:2,isTabHolderVisible:2,undoStack:2,sortManager:2,filter:2,showFilterIcons:2,definedNames:2,enableDragDrop:2,enableFormulas:2,selectedSheetChanged:1,draggingRowColumn:1,droppingRowColumn:1,loaded:1,unknownFunction:1,sheetCleared:1,prepareChangingRow:1,prepareChangingColumn:1,rowChanged:1,columnChanged:1});
...
/// <summary>Initializes a new instance of the @see:RowColumnChangedEventArgs class.</summary>
...
wijmo.grid.sheet.FlexSheetPanel.prototype.setCellData = function(r, c, value, coerce, invalidate) {
/// <summary>Sets the content of a cell in the panel.</summary>
/// <param name="r" type="Number" optional="false">The index of the row that contains the cell.</param>
/// <param name="c" type="Object" optional="false">The index, name, or binding of the column that contains the cell.</param>
/// <param name="value" type="Object" optional="false">The value to store in the cell.</param>
...
wijmo.grid.sheet.DefinedName = function(owner, name, value, sheetName) {
/// <summary>Initializes a new instance of the DefinedName class.</summary>
/// <param name="owner" type="wijmo.grid.sheet.FlexSheet" optional="false">The owner @see: FlexSheet control.</param>
/// <param name="name" type="String" optional="false">The name of the defined name item.</param>
/// <param name="value" type="Object" optional="false">The value of the defined name item.</param>
/// <param name="sheetName" type="String" optional="true">The sheet name indicates the defined name item works in which sheet of FlexSheet.  If omitted, the defined name item works in all sheets of FlexSheet.</param>
/// <returns type="wijmo.xlsx.DefinedName"></returns>
/// <field name="name" type="String">Gets or sets the name of the defined name item.</field>
/// <field name="value" type="Object">Gets or sets the value of the defined name item.</field>
/// <field name="sheetName" type="String">Gets the sheetName of the defined name item.</field>
this._wjClassName = 'wijmo.grid.sheet.DefinedName';
_wjReownEvents(this);
}
wijmo.grid.sheet.DefinedName._wjDict = _wjMerge({}, {name:2,value:2,sheetName:2});
wijmo.grid.sheet.DefinedName._wjClass = true;
wijmo.grid.sheet.Sheet = function(owner, grid, sheetName, rows, cols) {
/// <summary>Initializes a new instance of the @see:Sheet class.</summary>
...
/// <field name="filterSetting" type="wijmo.grid.sheet.IFilterSetting">Gets or sets the filter setting for this sheet.</field>
/// <field name="tables" type="wijmo.collections.ObservableArray">Gets the collection of the @see:Table objects on this Sheet.
/// It allows to insert/remove @see:Table on this Sheet via the tables collection.</field>
...
wijmo.grid.sheet.Sheet.prototype.dispose = function() {
/// <summary>Dispose sheet instance.</summary>
}
...
wijmo.grid.sheet.Sheet.prototype.addTableFromArray = function(row, column, array, properties, tableName, tableStyle, options, shift) {
/// <summary>Add table from an object array.</summary>
/// <param name="row" type="Number" optional="false">The row position of the table.</param>
/// <param name="column" type="Number" optional="false">The column position of the table.</param>
/// <param name="array" type="Object[]" optional="false">The object array load to the table.</param>
/// <param name="properties" type="String[]" optional="true">It allows to retrieve only a subset of columns from the object of the array.  If it is omitted, the table will load all the keys of the object of the array.</param>
/// <param name="tableName" type="String" optional="true">The name of the table.</param>
/// <param name="tableStyle" type="wijmo.grid.sheet.TableStyle" optional="true">The table style is applied to the table.</param>
/// <param name="options" type="wijmo.grid.sheet.ITableOptions" optional="true">The options @see:ITableOptions of the table.</param>
/// <param name="shift" type="Boolean" optional="true">Indicates whether cells beneath the table should be shifted or not.  If not specified cells beneath will be shifted.</param>
/// <returns type="wijmo.grid.sheet.Table">the table if the table was added successfully, otherwise retun null.</returns>
}
wijmo.grid.sheet.Sheet.prototype.findTable = function(rowIndex, columnIndex) {
/// <summary>Finds the table via the cell location.</summary>
/// <param name="rowIndex" type="Number" optional="false">the row index of the specified cell.</param>
/// <param name="columnIndex" type="Number" optional="false">the column index of the specified cell.</param>
/// <returns type="wijmo.grid.sheet.Table"></returns>
}
wijmo.grid.sheet.Sheet._wjDict = _wjMerge({}, {grid:2,name:2,visible:2,rowCount:2,columnCount:2,selectionRanges:2,itemsSource:2,filterSetting:2,tables:2,nameChanged:1,visibleChanged:1});
...
wijmo.grid.sheet.SortManager.prototype.clearSort = function() {
/// <summary>Clear the sort descriptions.</summary>
}
...
wijmo.grid.sheet.ColumnSortDescription.prototype.clone = function() {
/// <summary>Creates a copy of the ColumnSortDescription.</summary>
/// <returns type="wijmo.grid.sheet.ColumnSortDescription"></returns>
}
...
/// <field name="stackSize" type="Number">Gets or sets the size of the undo stack.</field>
...
wijmo.grid.sheet.UndoStack._wjDict = _wjMerge({}, {stackSize:2,canUndo:2,canRedo:2,undoStackChanged:1});
wijmo.grid.sheet.UndoStack._wjClass = true;
wijmo.grid.sheet.Table = function(name, range, style, columns, options) {
/// <summary>Initializes a new instance of the @see:Table class.</summary>
/// <param name="name" type="String" optional="false">The name of the table.</param>
/// <param name="range" type="wijmo.grid.CellRange" optional="false">The range of the table.</param>
/// <param name="style" type="wijmo.grid.sheet.TableStyle" optional="true">The table style to use with the table.  The default style is the 'TableStyleMedium9' built-in table style, if the style is omitted.</param>
/// <param name="columns" type="wijmo.grid.sheet.TableColumn[]" optional="true">The columns of the table.</param>
/// <param name="options" type="wijmo.grid.sheet.ITableOptions" optional="true">The options @see:ITableOptions of the table.</param>
/// <returns type="wijmo.grid.sheet.Table"></returns>
/// <field name="name" type="String">Gets or sets the table name.
/// 
/// The table name is used to reference the table programmatically.</field>
/// <field name="sheet" type="wijmo.grid.sheet.Sheet">Gets the @see:Sheet this table belongs to.</field>
/// <field name="style" type="wijmo.grid.sheet.TableStyle">Gets or sets the @see:TableStyle associated with this table.</field>
/// <field name="showHeaderRow" type="Boolean">Indicates whether the table should include a header row.</field>
/// <field name="showTotalRow" type="Boolean">Indicates whether the table should include a total row.</field>
/// <field name="showBandedColumns" type="Boolean">Indicating whether banded column formatting is applied.</field>
/// <field name="showBandedRows" type="Boolean">Gets or sets a value that determines whether banded row
/// formatting is applied.</field>
/// <field name="alterFirstColumn" type="Boolean">Gets or sets a value that determines whether the first table
/// column should have the style applied.</field>
/// <field name="alterLastColumn" type="Boolean">Gets or sets a value that determines whether the last table
/// column should have the style applied.</field>
this._wjClassName = 'wijmo.grid.sheet.Table';
_wjReownEvents(this);
}
wijmo.grid.sheet.Table.prototype.getRange = function(section, column) {
/// <summary>Gets the range of the specific section and column on the relevant sheet that the table occupies.</summary>
/// <param name="section" type="wijmo.grid.sheet.TableSection" optional="true">The section of Table.  If the section is omitted.  It will get the range of entire table.</param>
/// <param name="column" type="Object" optional="true">The column of Table. The column could be @see:TableColumn instance, column name or column index.
///      If the column is omitted.  It will get the range for all columns in the table.
///      If the section is null, the reference of the specific column includes the header row and the totals row if they are visible.</param>
/// <returns type="wijmo.grid.CellRange">the range of the specific table section and specific column, if the specific column doesn't exist in table it will return null.</returns>
}
wijmo.grid.sheet.Table.prototype.getColumns = function() {
/// <summary>Gets the table's columns.</summary>
/// <returns type="wijmo.grid.sheet.TableColumn[]"></returns>
}
wijmo.grid.sheet.Table.prototype.insertRows = function(index, count, shift) {
/// <summary>Insert rows into Table.</summary>
/// <param name="index" type="Number" optional="false">The position where new rows should be added in table.</param>
/// <param name="count" type="Number" optional="true">The numbers of rows to add. If not specified then one row will be added.</param>
/// <param name="shift" type="Boolean" optional="true">Indicates whether cells beneath the table should be shifted or not.  If not specified cells beneath will be shifted.</param>
/// <returns type="Boolean">True if the rows are inserted successfully.</returns>
}
wijmo.grid.sheet.Table.prototype.deleteRows = function(index, count, shift) {
/// <summary>Delete rows of Table.</summary>
/// <param name="index" type="Number" optional="false">The starting index of the deleting rows in Table.</param>
/// <param name="count" type="Number" optional="true">The numbers of rows to delete. If not specified then one row will be deleted.</param>
/// <param name="shift" type="Boolean" optional="true">Indicates whether cells beneath the table should be shifted or not.  If not specified cells beneath will be shifted.</param>
}
wijmo.grid.sheet.Table._wjDict = _wjMerge({}, {name:2,sheet:2,style:2,showHeaderRow:2,showTotalRow:2,showBandedColumns:2,showBandedRows:2,alterFirstColumn:2,alterLastColumn:2});
wijmo.grid.sheet.Table._wjClass = true;
wijmo.grid.sheet.TableColumn = function(name, totalRowLabel, totalRowFunction, showFilterButton) {
/// <summary>Initializes a new instance of the @see:TableColumn class.</summary>
/// <param name="name" type="String" optional="false">The name of the table column.</param>
/// <param name="totalRowLabel" type="String" optional="true">The string to show in the totals row cell for the column.</param>
/// <param name="totalRowFunction" type="String" optional="true">The function to show in the totals row cell for this column.</param>
/// <param name="showFilterButton" type="Boolean" optional="true">Indicating whether show the filter button for the table column.  The default value of showFilterButton is true.</param>
/// <returns type="wijmo.grid.sheet.TableColumn"></returns>
/// <field name="table" type="wijmo.grid.sheet.Table">Gets the Table the table columns belongs to.</field>
/// <field name="name" type="String">Gets the name of the table column. It is referenced through functions.</field>
/// <field name="totalRowLabel" type="String">The string to show in the totals row cell for the column.</field>
/// <field name="totalRowFunction" type="String">The function to show in the totals row cell for the column.</field>
/// <field name="showFilterButton" type="Boolean">Indicating whether show the filter button for the table column.
/// 
/// As FlexSheet has not supported filter for table yet, this property is used for import/export operation only by now.</field>
this._wjClassName = 'wijmo.grid.sheet.TableColumn';
_wjReownEvents(this);
}
wijmo.grid.sheet.TableColumn._wjDict = _wjMerge({}, {table:2,name:2,totalRowLabel:2,totalRowFunction:2,showFilterButton:2});
wijmo.grid.sheet.TableColumn._wjClass = true;
wijmo.grid.sheet.TableStyle = function(name, isBuiltIn) {
/// <summary>Initializes a new instance of the @see:TableStyle class.</summary>
/// <param name="name" type="String" optional="false">The name of the table style.</param>
/// <param name="isBuiltIn" type="Boolean" optional="true">Indicates whether the table style is built-in style.</param>
/// <returns type="wijmo.grid.sheet.TableStyle"></returns>
/// <field name="name" type="String">Gets or sets the name of the table style.</field>
/// <field name="wholeTableStyle" type="wijmo.grid.sheet.ITableSectionStyle">Gets or sets the whole table style.</field>
/// <field name="firstBandedColumnStyle" type="wijmo.grid.sheet.IBandedTableSectionStyle">Gets or sets the first banded column style.</field>
/// <field name="secondBandedColumnStyle" type="wijmo.grid.sheet.IBandedTableSectionStyle">Gets or sets the second banded column style.</field>
/// <field name="firstBandedRowStyle" type="wijmo.grid.sheet.IBandedTableSectionStyle">Gets or sets the first banded row style.</field>
/// <field name="secondBandedRowStyle" type="wijmo.grid.sheet.IBandedTableSectionStyle">Gets or sets the second banded row style.</field>
/// <field name="firstColumnStyle" type="wijmo.grid.sheet.ITableSectionStyle">Gets or sets the first column style.</field>
/// <field name="lastColumnStyle" type="wijmo.grid.sheet.ITableSectionStyle">Gets or sets the last column style.</field>
/// <field name="headerRowStyle" type="wijmo.grid.sheet.ITableSectionStyle">Gets or sets the header row style.</field>
/// <field name="totalRowStyle" type="wijmo.grid.sheet.ITableSectionStyle">Gets or sets the total row style.</field>
/// <field name="firstHeaderCellStyle" type="wijmo.grid.sheet.ITableSectionStyle">Gets or sets the first cell style in the header row.</field>
/// <field name="lastHeaderCellStyle" type="wijmo.grid.sheet.ITableSectionStyle">Gets or sets the last cell style in the header row.</field>
/// <field name="firstTotalCellStyle" type="wijmo.grid.sheet.ITableSectionStyle">Gets or sets the first cell style in the total row.</field>
/// <field name="lastTotalCellStyle" type="wijmo.grid.sheet.ITableSectionStyle">Gets or sets the last cell style in the total row.</field>
/// <field name="isBuiltIn" type="Boolean">Indicates whether the table style is built-in style.</field>
this._wjClassName = 'wijmo.grid.sheet.TableStyle';
_wjReownEvents(this);
}
wijmo.grid.sheet.TableStyle._wjDict = _wjMerge({}, {name:2,wholeTableStyle:2,firstBandedColumnStyle:2,secondBandedColumnStyle:2,firstBandedRowStyle:2,secondBandedRowStyle:2,firstColumnStyle:2,lastColumnStyle:2,headerRowStyle:2,totalRowStyle:2,firstHeaderCellStyle:2,lastHeaderCellStyle:2,firstTotalCellStyle:2,lastTotalCellStyle:2,isBuiltIn:2});
wijmo.grid.sheet.TableStyle._wjClass = true;
wijmo.grid.sheet.TableSection = {
...
intellisense.annotate(wijmo.grid.sheet, {
// Specifies constants define the section of Table.
TableSection: undefined
});

wijmo.grid.sheet.FlexSheetValueFilter = function(column) {
/// <summary>Initializes a new instance of the @see:FlexSheetValueFilter class.</summary>
/// <param name="column" type="wijmo.grid.Column" optional="false">The column to filter.</param>
/// <returns type="wijmo.grid.sheet.FlexSheetValueFilter"></returns>
this._wjClassName = 'wijmo.grid.sheet.FlexSheetValueFilter';
_wjReownEvents(this);
}
wijmo.grid.sheet.FlexSheetValueFilter.prototype = new wijmo.grid.filter.ValueFilter();
wijmo.grid.sheet.FlexSheetValueFilter.prototype.apply = function(value) {
/// <summary>Gets a value that indicates whether a value passes the filter.</summary>
/// <param name="value" type="Object" optional="false">The value to test.</param>
/// <returns type="Boolean"></returns>
}
wijmo.grid.sheet.FlexSheetValueFilter._wjDict = _wjMerge(wijmo.grid.filter.ValueFilter._wjDict, {});
wijmo.grid.sheet.FlexSheetValueFilter._wjClass = true;
wijmo.grid.sheet.FlexSheetValueFilterEditor = function() {
/// <summary>The editor used to inspect and modify @see:FlexSheetValueFilter objects.
/// This class is used by the @see:FlexSheetFilter class; you
/// rarely use it directly.</summary>
/// <returns type="wijmo.grid.sheet.FlexSheetValueFilterEditor"></returns>
this._wjClassName = 'wijmo.grid.sheet.FlexSheetValueFilterEditor';
_wjReownEvents(this);
}
wijmo.grid.sheet.FlexSheetValueFilterEditor.prototype = new wijmo.grid.filter.ValueFilterEditor();
wijmo.grid.sheet.FlexSheetValueFilterEditor.prototype.updateEditor = function() {
/// <summary>Updates editor with current filter settings.</summary>
}
wijmo.grid.sheet.FlexSheetValueFilterEditor.prototype.updateFilter = function() {
/// <summary>Updates filter to reflect the current editor values.</summary>
}
wijmo.grid.sheet.FlexSheetValueFilterEditor._wjDict = _wjMerge(wijmo.grid.filter.ValueFilterEditor._wjDict, {});
wijmo.grid.sheet.FlexSheetValueFilterEditor._wjClass = true;
wijmo.grid.sheet.FlexSheetConditionFilter = function(column) {
/// <summary>Initializes a new instance of the @see:ConditionFilter class.</summary>
/// <param name="column" type="wijmo.grid.Column" optional="false">The column to filter.</param>
/// <returns type="wijmo.grid.sheet.FlexSheetConditionFilter"></returns>
this._wjClassName = 'wijmo.grid.sheet.FlexSheetConditionFilter';
_wjReownEvents(this);
}
wijmo.grid.sheet.FlexSheetConditionFilter.prototype = new wijmo.grid.filter.ConditionFilter();
wijmo.grid.sheet.FlexSheetConditionFilter.prototype.apply = function(value) {
/// <summary>Returns a value indicating whether a value passes this filter.</summary>
/// <param name="value" type="Object" optional="false">The value to test.</param>
/// <returns type="Boolean"></returns>
}
wijmo.grid.sheet.FlexSheetConditionFilter._wjDict = _wjMerge(wijmo.grid.filter.ConditionFilter._wjDict, {});
wijmo.grid.sheet.FlexSheetConditionFilter._wjClass = true;
wijmo.grid.sheet.FlexSheetColumnFilter = function(owner, column) {
/// <summary>Initializes a new instance of the @see:FlexSheetColumnFilter class.</summary>
/// <param name="owner" type="wijmo.grid.sheet.FlexSheetFilter" optional="false">The @see:FlexSheetFilter that owns this column filter.</param>
/// <param name="column" type="wijmo.grid.Column" optional="false">The @see:Column to filter.</param>
/// <returns type="wijmo.grid.sheet.FlexSheetColumnFilter"></returns>
this._wjClassName = 'wijmo.grid.sheet.FlexSheetColumnFilter';
_wjReownEvents(this);
}
wijmo.grid.sheet.FlexSheetColumnFilter.prototype = new wijmo.grid.filter.ColumnFilter();
wijmo.grid.sheet.FlexSheetColumnFilter._wjDict = _wjMerge(wijmo.grid.filter.ColumnFilter._wjDict, {});
wijmo.grid.sheet.FlexSheetColumnFilter._wjClass = true;
wijmo.grid.sheet.FlexSheetColumnFilterEditor = function(element, filter, sortButtons) {
/// <summary>Initializes a new instance of the @see:FlexSheetColumnFilterEditor class.</summary>
/// <param name="element" type="Object" optional="false">The DOM element that hosts the control, or a selector
/// for the host element (e.g. '#theCtrl').</param>
/// <param name="filter" type="wijmo.grid.sheet.FlexSheetColumnFilter" optional="false">The @see:FlexSheetColumnFilter to edit.</param>
/// <param name="sortButtons" type="Boolean" optional="true">Whether to show sort buttons in the editor.</param>
/// <returns type="wijmo.grid.sheet.FlexSheetColumnFilterEditor"></returns>
this._wjClassName = 'wijmo.grid.sheet.FlexSheetColumnFilterEditor';
_wjReownEvents(this);
}
wijmo.grid.sheet.FlexSheetColumnFilterEditor.prototype = new wijmo.grid.filter.ColumnFilterEditor();
wijmo.grid.sheet.FlexSheetColumnFilterEditor._wjDict = _wjMerge(wijmo.grid.filter.ColumnFilterEditor._wjDict, {});
wijmo.grid.sheet.FlexSheetColumnFilterEditor._wjClass = true;
wijmo.grid.sheet.FlexSheetFilter = function() {
/// <summary>Implements an Excel-style filter for @see:FlexSheet controls.
...
/// constructor.</summary>
/// <returns type="wijmo.grid.sheet.FlexSheetFilter"></returns>
/// <field name="filterDefinition" type="String">Gets or sets the current filter definition as a JSON string.</field>
this._wjClassName = 'wijmo.grid.sheet.FlexSheetFilter';
_wjReownEvents(this);
}
wijmo.grid.sheet.FlexSheetFilter.prototype = new wijmo.grid.filter.FlexGridFilter();
wijmo.grid.sheet.FlexSheetFilter.prototype.apply = function() {
/// <summary>Applies the current column filters to the sheet.</summary>
}
wijmo.grid.sheet.FlexSheetFilter.prototype.editColumnFilter = function(col, ht) {
/// <summary>Shows the filter editor for the given grid column.</summary>
/// <param name="col" type="Object" optional="false">The @see:Column that contains the filter to edit.</param>
/// <param name="ht" type="wijmo.grid.HitTestInfo" optional="true">A @see:wijmo.chart.HitTestInfo object containing the range of the cell that
/// triggered the filter display.</param>
}
wijmo.grid.sheet.FlexSheetFilter.prototype.closeEditor = function() {
/// <summary>Closes the filter editor.</summary>
}
wijmo.grid.sheet.FlexSheetFilter.prototype.getColumnFilter = function(col, create) {
/// <summary>Gets the filter for the given column.</summary>
/// <param name="col" type="Object" optional="false">The @see:Column that the filter applies to (or column name or index).</param>
/// <param name="create" type="Boolean" optional="true">Whether to create the filter if it does not exist.</param>
/// <returns type="wijmo.grid.sheet.FlexSheetColumnFilter"></returns>
}
wijmo.grid.sheet.FlexSheetFilter._wjDict = _wjMerge(wijmo.grid.filter.FlexGridFilter._wjDict, {filterDefinition:2});
wijmo.grid.sheet.FlexSheetFilter._wjClass = true;
...
wijmo.chart.finance.FinancialSeries.prototype.getDataRect = function(currentRect, calculatedRect) {
/// <summary>Returns the series bounding rectangle in data coordinates.
/// 
/// If getDataRect() returns null, the limits are calculated automatically based on the data values.</summary>
/// <param name="currentRect" type="wijmo.Rect" optional="true">The current rectangle of chart. This parameter is optional.</param>
...
wijmo.chart.finance.PointAndFigureScaling = {
...
PointAndFigureScaling: undefined
});
...
/// <field name="valueField" type="wijmo.olap.PivotField">Gets the @see:PivotField that contains the main value for this key.</field>
...
/// <field name="level" type="Number">Gets the subtotal level that this key represents.
/// 
/// The value -1 indicates the key does not represent a subtotal.
/// Zero indicates a grand total.
/// Values greater than zero indicate the subtotal level.</field>
...
wijmo.olap._PivotKey._wjDict = _wjMerge({}, {fields:2,valueFields:2,valueField:2,values:2,fieldNames:2,aggregate:2,level:2});
...
/// <field name="getValue" type="Function">Gets or sets a function to be used for retrieving the field values.
/// 
...
/// the calculated value for the item.</field>
/// <field name="header" type="String">Gets or sets a string used to represent this field in the user
/// interface.
/// 
/// The default value for this property is a capitalized version of the
/// @see:binding value.</field>
/// <field name="filter" type="wijmo.olap.PivotFilter">Gets a reference to the @see:PivotFilter used to filter values for this field.
/// 
...
/// applied to the raw data.</field>
/// <field name="aggregate" type="wijmo.Aggregate">Gets or sets how the field should be summarized.
/// 
/// The default value for this property is <b>Aggregate.Sum</b>
/// for numeric fields, and <b>Aggregate.Count</b> for other
/// field types.</field>
/// <field name="showAs" type="wijmo.olap.ShowAs">Gets or sets a value that specifies how to display the aggregate
/// value.
/// 
...
/// feature in Excel.
/// 
/// The default value for this property is <b>ShowAs.NoCalculation</b>.</field>
...
/// <field name="isMeasure" type="Boolean">Gets a value that indicates whether the field is a measure or
/// a dimension.
/// 
...
/// can be used to divide measures into categories.</field>
/// <field name="subFields" type="wijmo.olap.PivotField[]">Gets this field's child fields.</field>
/// <field name="format" type="String">Gets or sets the format to use when displaying field values.
/// 
/// The default value for this property is
/// <b>'d'</b> for date fields, <b>'n0'</b> for numeric fields,
/// and the empty string for other field types.</field>
/// <field name="width" type="Number">Gets or sets the preferred width to be used for showing this
/// field in user interface controls such as the @see:PivotGrid.</field>
/// <field name="wordWrap" type="Boolean">Gets or sets a value that indicates whether the content of this
...
/// 
/// The default value for this property is <b>false</b>.</field>
/// <field name="visible" type="Boolean">Gets or sets a value indicating whether this field should be
...
/// the field position in the engine's view definition.</field>
/// <field name="sortComparer" type="Function">Gets or sets a function used to compare values when sorting.
/// 
/// If provided, the sort comparer function should take as parameters
/// two values of any type, and should return -1, 0, or +1 to indicate
...
wijmo.olap.PivotField._wjDict = _wjMerge({}, {binding:2,getValue:2,header:2,filter:2,aggregate:2,showAs:2,weightField:2,dataType:2,isMeasure:2,subFields:2,format:2,width:2,wordWrap:2,descending:2,isContentHtml:2,visible:2,sortComparer:2,engine:2,collectionView:2,isActive:2,parentField:2,key:2,propertyChanged:1});
wijmo.olap.PivotField._wjClass = true;
wijmo.olap.CubePivotField = function(engine, binding, header, options) {
/// <summary>Initializes a new instance of the @see:CubePivotField class.</summary>
/// <param name="engine" type="wijmo.olap.PivotEngine" optional="false">@see:PivotEngine that owns this field.</param>
/// <param name="binding" type="String" optional="false">Property that this field is bound to.</param>
/// <param name="header" type="String" optional="true">Header shown to identify this field (defaults to the binding).</param>
/// <param name="options" type="Object" optional="true">JavaScript object containing initialization data for the field.</param>
...
/// <field name="isMeasure" type="Boolean">Overridden to account for the dimension type.</field>
...
wijmo.olap.CubePivotField._wjDict = _wjMerge(wijmo.olap.PivotField._wjDict, {header:2,dimensionType:2,isMeasure:2,key:2});
...
/// sample shows all options working with a single @see:PivotEngine.</field>
/// <field name="isServer" type="Boolean">Gets a value that determines whether the engine is bound to a server
/// @see:itemsSource or is using local data.</field>
...
/// 
/// The default value for this property is <b>ShowTotals.GrandTotals</b>.</field>
...
/// 
/// The default value for this property is <b>false</b>.</field>
/// <field name="sortableGroups" type="Boolean">Gets or sets a value that determines whether the engine should
...
/// 
/// The default value for this property is <b>true</b>.</field>
/// <field name="sortOnServer" type="Boolean">Gets or sets a value that indicates whether the summary data received
...
/// 
/// The default value for this property is <b>false</b>.</field>
/// <field name="defaultFilterType" type="wijmo.grid.filter.FilterType">Gets or sets the default filter type (by value or by condition).
/// 
/// The default value for this property is <b>null</b>, which causes
/// the engine to use <b>FilterType.Both</b> on the client or
/// <b>FilterType.Condition</b> on the server.</field>
...
/// <field name="rowFields" type="wijmo.olap.PivotFieldCollection">Gets the list of @see:PivotField objects that define the fields shown as
/// rows in the output table.</field>
/// <field name="columnFields" type="wijmo.olap.PivotFieldCollection">Gets the list of @see:PivotField objects that define the fields shown as
/// columns in the output table.</field>
/// <field name="filterFields" type="wijmo.olap.PivotFieldCollection">Gets the list of @see:PivotField objects that define the fields
/// used as filters.
/// 
/// Fields on this list do not appear in the output table,
/// but are still used for filtering the input data.</field>
/// <field name="valueFields" type="wijmo.olap.PivotFieldCollection">Gets the list of @see:PivotField objects that define the fields
/// summarized in the output table.</field>
...
/// or @see:columnFields lists are not empty.</field>
/// <field name="isUpdating" type="Boolean">Gets a value that indicates whether the engine is currently being updated.</field>
/// <field name="async" type="Boolean">Gets or sets a value that determines whether view updates
...
/// 
/// The default value for this property is <b>true</b>.</field>
/// <field name="serverTimeout" type="Number">Gets or sets the maximum amount of time, in milliseconds, that
...
/// than that, set the property to a higher value.</field>
/// <field name="serverPollInterval" type="Number">Gets or sets the amount of time, in milliseconds, that the
...
/// every half second.</field>
/// <field name="serverMaxDetail" type="Number">Gets or sets the maximum number of records the @see:getDetail
...
/// increase the value of this property.</field>
...
wijmo.olap.PivotEngine._wjDict = _wjMerge({}, {itemsSource:2,isServer:2,collectionView:2,pivotView:2,showRowTotals:2,showColumnTotals:2,totalsBeforeData:2,sortableGroups:2,sortOnServer:2,showZeros:2,defaultFilterType:2,autoGenerateFields:2,allowFieldEditing:2,fields:2,rowFields:2,columnFields:2,filterFields:2,valueFields:2,viewDefinition:2,isViewDefined:2,isUpdating:2,async:2,serverTimeout:2,serverPollInterval:2,serverMaxDetail:2,itemsSourceChanged:1,viewDefinitionChanged:1,updatingView:1,updatedView:1,error:1});
...
wijmo.olap._MdxQueryBuilder = function(engine, cubeName) {
/// <summary>Initializes a new instance of the @see:_MdxQueryBuilder class.</summary>
/// <param name="engine" type="wijmo.olap.PivotEngine" optional="false">@see:PivotEngine from which to derive a query.</param>
/// <param name="cubeName" type="String" optional="false">Name of the cube to be queried.</param>
/// <returns type="wijmo.olap._MdxQueryBuilder"></returns>
this._wjClassName = 'wijmo.olap._MdxQueryBuilder';
_wjReownEvents(this);
}
wijmo.olap._MdxQueryBuilder.prototype.buildQuery = function() {
/// <summary>Builds the MDX query according to information from the @see:PivotEngine.</summary>
/// <returns type="String"></returns>
}
wijmo.olap._MdxQueryBuilder.prototype.buildWhereSection = function(measureShelf) {
/// <summary>Builds expressions for the WHERE section of the MDX query.</summary>
/// <param name="measureShelf" type="wijmo.olap.PivotFieldCollection" optional="false">Collection of measure fields.</param>
/// <returns type="String"></returns>
}
wijmo.olap._MdxQueryBuilder.prototype.buildCubeName = function() {
/// <summary>Returns the cube name for the FROM section of the MDX query.</summary>
/// <returns type="String"></returns>
}
wijmo.olap._MdxQueryBuilder.prototype.buildSubcubeExpression = function() {
/// <summary>Builds the subcube section.</summary>
/// <returns type="String"></returns>
}
wijmo.olap._MdxQueryBuilder.prototype.buildAxes = function() {
/// <summary>Builds expressions for the SELECT section of the MDX query.</summary>
/// <returns type="String"></returns>
}
wijmo.olap._MdxQueryBuilder.prototype.buildSetForAttributesShelf = function(shelf) {
/// <summary>Builds set for one axis.</summary>
/// <param name="shelf" type="wijmo.olap.PivotFieldCollection" optional="false">Collection of fields to include in tuples of the set.</param>
/// <returns type="String"></returns>
}
wijmo.olap._MdxQueryBuilder.prototype.buildSetForAttributesColumnShelf = function(shelf) {
/// <summary>Builds set for one axis.</summary>
/// <param name="shelf" type="wijmo.olap.PivotFieldCollection" optional="false">Collection of fields to include in tuples of the set.</param>
/// <returns type="String"></returns>
}
wijmo.olap._MdxQueryBuilder.prototype.buildSetForMeasuresShelf = function(shelf) {
/// <summary>Builds set for one axis.</summary>
/// <param name="shelf" type="wijmo.olap.PivotFieldCollection" optional="false">Collection of fields to include in tuples of the set.</param>
/// <returns type="String"></returns>
}
wijmo.olap._MdxQueryBuilder.prototype.buildAttributeSetForAxis = function(field) {
/// <summary>Builds set for one attribute.</summary>
/// <param name="field" type="wijmo.olap.CubePivotField" optional="false">Attribute or named set.</param>
/// <returns type="String"></returns>
}
wijmo.olap._MdxQueryBuilder.prototype.buildMeasureSetForAxis = function(field) {
/// <summary>Builds set for one attribute.</summary>
/// <param name="field" type="wijmo.olap.CubePivotField" optional="false">Attribute or named set.</param>
/// <returns type="String"></returns>
}
wijmo.olap._MdxQueryBuilder._wjDict = _wjMerge({}, {});
wijmo.olap._MdxQueryBuilder._wjClass = true;
...
wijmo.olap._SqlServerConnection = function(engine, options) {
/// <summary>Initializes a new instance of the @see:_SqlServerConnection class.</summary>
/// <param name="engine" type="wijmo.olap.PivotEngine" optional="false">@see:PivotEngine that owns this field.</param>
/// <param name="options" type="Object" optional="false">Options used to communicate with the server.</param>
/// <returns type="wijmo.olap._SqlServerConnection"></returns>
this._wjClassName = 'wijmo.olap._SqlServerConnection';
_wjReownEvents(this);
}
wijmo.olap._SqlServerConnection.prototype = new wijmo.olap._ServerConnection();
wijmo.olap._SqlServerConnection.prototype.getFields = function() {
/// <summary>Gets a list of fields available on the server.</summary>
/// <returns type="wijmo.olap.PivotField[]"></returns>
}
wijmo.olap._SqlServerConnection.prototype.getOutputView = function(callBack) {
/// <summary>Gets the output view for the current view definition.</summary>
/// <param name="callBack" type="Function" optional="false">function invoked to handle the results.</param>
}
wijmo.olap._SqlServerConnection.prototype.getDetail = function(rowKey, colKey) {
/// <summary>Gets an array containing the data items that were used to calculate
/// an aggregated cell.</summary>
/// <param name="rowKey" type="Object" optional="false">Identifies the row that contains the aggregated cell.</param>
/// <param name="colKey" type="Object" optional="false">Identifies the column that contains the aggregated cell.</param>
...
wijmo.olap._SqlServerConnection._wjDict = _wjMerge(wijmo.olap._ServerConnection._wjDict, {});
wijmo.olap._SqlServerConnection._wjClass = true;
wijmo.olap._TextBuilder = function() {
/// <summary>Initializes a new instance of the @see:_TextBuilder class.</summary>
/// <returns type="wijmo.olap._TextBuilder"></returns>
/// <field name="length" type="Number">Returns the text length.</field>
this._wjClassName = 'wijmo.olap._TextBuilder';
_wjReownEvents(this);
}
wijmo.olap._TextBuilder.prototype.toString = function() {
/// <summary>Returns the text.</summary>
/// <returns type="String"></returns>
}
wijmo.olap._TextBuilder.prototype.append = function(items) {
/// <summary>Appends a concatenation of strings.</summary>
/// <param name="items" type="String[]" optional="false">Array of strings to be appended.</param>
}
wijmo.olap._TextBuilder.prototype.joinToList = function(separator, parts) {
/// <summary>Appends a separator followed by a concatenation of strings.</summary>
/// <param name="separator" type="String" optional="false">Separator string.</param>
/// <param name="parts" type="String[]" optional="false">Array of strings to be appended.</param>
}
wijmo.olap._TextBuilder.prototype.joinItemToList = function(item) {
/// <summary>Appends a comma separator followed by an individual string.</summary>
/// <param name="item" type="String" optional="false">String to be appended.</param>
}
wijmo.olap._TextBuilder.prototype.wrap = function(prefix, suffix) {
/// <summary>Wraps a non-empty string with the specified prefix and suffix.</summary>
/// <param name="prefix" type="String" optional="false">Prefix string.</param>
/// <param name="suffix" type="String" optional="false">Suffix string.</param>
}
wijmo.olap._TextBuilder.wrap = function(prefix, text, suffix) {
/// <summary>Wraps a non-empty string with the specified prefix and suffix.</summary>
/// <param name="prefix" type="String" optional="false">Prefix string.</param>
/// <param name="text" type="String" optional="false">Text to be wrapped.</param>
/// <param name="suffix" type="String" optional="false">Suffix string.</param>
}
wijmo.olap._TextBuilder._wjDict = _wjMerge({}, {length:2});
wijmo.olap._TextBuilder._wjClass = true;
...
/// <field name="showFieldIcons" type="Boolean">Gets or sets a value that determines whether the main field list should
/// include icons indicating whether fields are measure or dimension fields.
/// 
/// The default value for this property is <b>true</b>.</field>
/// <field name="restrictDragging" type="Boolean">Gets or sets a value that determines whether the panel should restrict
...
wijmo.olap.PivotPanel._wjDict = _wjMerge(wijmo.Control._wjDict, {engine:2,itemsSource:2,collectionView:2,pivotView:2,autoGenerateFields:2,fields:2,rowFields:2,columnFields:2,valueFields:2,filterFields:2,viewDefinition:2,isViewDefined:2,showFieldIcons:2,restrictDragging:2,itemsSourceChanged:1,viewDefinitionChanged:1,updatingView:1,updatedView:1});
...
/// <param name="element" type="Object" optional="false">The DOM element that will host the control, or a CSS selector for the host element (e.g. '#theCtrl').</param>
/// <param name="options" type="Object" optional="true">JavaScript object containing initialization data for the control.</param>
...
/// 
/// The default value for this property is <b>true</b>.</field>
/// <field name="detailDialog" type="wijmo.olap.DetailDialog">Gets a reference to the @see:DetailDialog used to display the detail records
...
/// 
/// The default value for this property is <b>false</b>.</field>
/// <field name="customContextMenu" type="Boolean">Gets or sets a value that determines whether the grid should provide a
/// custom context menu.
/// 
...
/// 
/// The default value for this property is <b>true</b>.</field>
/// <field name="collapsibleSubtotals" type="Boolean">Gets or sets a value that determines whether the grid should allow
/// users to collapse and expand subtotal groups of rows and columns.
/// 
/// The default value for this property is <b>true</b>.</field>
/// <field name="centerHeadersVertically" type="Boolean">Gets or sets a value that determines whether the content of
...
wijmo.olap.PivotGrid._wjDict = _wjMerge(wijmo.grid.FlexGrid._wjDict, {engine:2,showDetailOnDoubleClick:2,detailDialog:2,showRowFieldHeaders:2,showColumnFieldHeaders:2,showRowFieldSort:2,customContextMenu:2,collapsibleSubtotals:2,centerHeadersVertically:2});
...
/// <field name="rowHeader" type="String">Gets the row header for the value being shown.
/// 
/// This information is updated before the dialog is shown and
/// is displayed above the detail grid.</field>
/// <field name="columnHeader" type="String">Gets the column header for the value being shown.
/// 
/// This information is updated before the dialog is shown and
/// is displayed above the detail grid.</field>
/// <field name="cellHeader" type="String">Gets the cell header for the value being shown.
/// 
/// This information is updated before the dialog is shown and
/// is displayed above the detail grid.</field>
/// <field name="cellValue" type="String">Gets the formatted cell value for the value being shown.
/// 
/// This information is updated before the dialog is shown and
/// is displayed above the detail grid.</field>
/// <field name="detailCount" type="Number">Gets the number of items shown in the detail dialog.
/// 
/// This information is updated before the dialog is shown and
/// is in the dialog header.</field>
this._wjClassName = 'wijmo.olap.DetailDialog';
_wjReownEvents(this);
}
wijmo.olap.DetailDialog.prototype = new wijmo.input.Popup();
wijmo.olap.DetailDialog.controlTemplate = undefined;
intellisense.annotate(wijmo.olap.DetailDialog, {
// Gets or sets the template used to instantiate @see:PivotFieldEditor controls.
controlTemplate: undefined
});
wijmo.olap.DetailDialog._wjDict = _wjMerge(wijmo.input.Popup._wjDict, {rowHeader:2,columnHeader:2,cellHeader:2,cellValue:2,detailCount:2});
...
/// <field name="chartType" type="wijmo.olap.PivotChartType">Gets or sets the type of chart to create.
/// 
/// The default value for this property is <b>PivotChartType.Column</b>.</field>
...
/// 
/// The default value for this property is <b>true</b>.</field>
/// <field name="showTotals" type="Boolean">Gets or sets a value that determines whether the chart should
/// include only totals.
/// 
...
/// 
/// The default value for this property is <b>false</b>.</field>
/// <field name="showTitle" type="Boolean">Gets or sets a value that determines whether the chart
/// should include a title.
/// 
/// The default value for this property is <b>true</b>.</field>
/// <field name="showLegend" type="wijmo.olap.LegendVisibility">Gets or sets a value that determines whether the chart
/// should include a legend.
/// 
/// The default value for this property is <b>LegendVisibility.Always</b>.</field>
...
/// 
/// The default value for this property is <b>Position.Right</b>.</field>
/// <field name="stacking" type="wijmo.chart.Stacking">Gets or sets a value that determines whether and how the
/// series objects are stacked.
/// 
/// The default value for this property is <b>Stacking.None</b>.</field>
/// <field name="maxSeries" type="Number">Gets or sets the maximum number of data series to be
/// shown in the chart.
/// 
/// The default value for this property is <b>100</b> series.</field>
/// <field name="maxPoints" type="Number">Gets or sets the maximum number of points to be shown in each series.
/// 
/// The default value for this property is <b>100</b> points.</field>
...
wijmo.olap.PivotChart.prototype.saveImageToDataUrl = function(format, done) {
/// <summary>Saves the chart to an image data url.
/// 
/// NOTE: This method does not work in IE browsers. If you require IE support,
/// add the <code>wijmo.chart.render</code> module to the page.</summary>
/// <param name="format" type="wijmo.chart.ImageFormat" optional="false">The @see:wijmo.chart.ImageFormat for the exported image.</param>
/// <param name="done" type="Function" optional="false">A function to be called after data url is generated. The function gets passed the data url as its argument.</param>
}
wijmo.olap.PivotChart.prototype.saveImageToFile = function(filename) {
/// <summary>Saves the chart to an image file.
/// 
/// NOTE: This method does not work in IE browsers. If you require IE support,
/// add the <code>wijmo.chart.render</code> module to the page.</summary>
...
wijmo.olap.PivotChart._wjDict = _wjMerge(wijmo.Control._wjDict, {engine:2,itemsSource:2,chartType:2,showHierarchicalAxes:2,showTotals:2,showTitle:2,showLegend:2,legendPosition:2,stacking:2,maxSeries:2,maxPoints:2,flexChart:2,flexPie:2,header:2,footer:2,headerStyle:2,footerStyle:2});
wijmo.olap.PivotChart._wjClass = true;
wijmo.olap.Slicer = function(element, options) {
/// <summary>Initializes a new instance of the @see:Slicer class.</summary>
/// <param name="element" type="Object" optional="false">The DOM element that hosts the control, or a CSS selector for the host element (e.g. '#theCtrl').</param>
/// <param name="options" type="Object" optional="true">The JavaScript object containing initialization data for the control.</param>
/// <returns type="wijmo.olap.Slicer"></returns>
/// <field name="field" type="wijmo.olap.PivotField">Gets or sets the @see:PivotField being filtered by this @see:Slicer.
/// 
...
/// remain active, but will not be shown in any @see:PivotPanel controls.</field>
/// <field name="header" type="String">Gets or sets the header string shown at the top of the @see:Slicer.
/// 
/// The default value for this property is null, which causes the @see:Slicer
/// to display the @see:field header at the top of the @see:Slicer.</field>
/// <field name="showHeader" type="Boolean">Gets or sets a value indicating whether the control displays the
/// header area with the header string and multi-select/clear buttons.
/// 
/// The default value for this property is <b>true</b>.</field>
/// <field name="showCheckboxes" type="Boolean">Gets or sets a value indicating whether the control displays
/// checkboxes next to each item.
/// 
/// The default value for this property is <b>false</b>.</field>
/// <field name="multiSelect" type="Boolean">Gets or sets a value that determines whether users should be allowed to
/// select multiple values from the list.
/// 
/// The default value for this property is <b>false</b>.</field>
this._wjClassName = 'wijmo.olap.Slicer';
_wjReownEvents(this);
}
wijmo.olap.Slicer.prototype = new wijmo.Control();
wijmo.olap.Slicer.controlTemplate = undefined;
intellisense.annotate(wijmo.olap.Slicer, {
// Gets or sets the template used to instantiate @see:Slicer controls.
controlTemplate: undefined
});
wijmo.olap.Slicer._wjDict = _wjMerge(wijmo.Control._wjDict, {field:2,header:2,showHeader:2,showCheckboxes:2,multiSelect:2});
wijmo.olap.Slicer._wjClass = true;
wijmo.viewer = wijmo.viewer || { _wjModule: true };
wijmo.viewer._saveBlob = function(blob, fileName) {
/// <summary>Saves the Blob object as a file.</summary>
/// <param name="blob" type="Blob" optional="false">The Blob object to save.</param>
/// <param name="fileName" type="String" optional="false">The name with which the file is saved.</param>
}
wijmo.viewer.RequestEventArgs = function(url, settings) {
/// <summary>Initializes a new instance of the @see:RequestEventArgs class.</summary>
/// <param name="url" type="String" optional="false">String containing the URL to which the request is sent.</param>
/// <param name="settings" type="Object" optional="false">An object used to configure the request. It has the
/// same structure and semantics as the <b>settings</b> parameter of the
/// @see:wijmo.httpRequest method.</param>
/// <returns type="wijmo.viewer.RequestEventArgs"></returns>
/// <field name="url" type="Object">Gets or sets the URL to which the request is sent.</field>
/// <field name="settings" type="Object">Gets or sets the object used to configure the request. It has the
/// same structure and semantics as the <b>settings</b> parameter of the
/// @see:wijmo.httpRequest method.</field>
this._wjClassName = 'wijmo.viewer.RequestEventArgs';
_wjReownEvents(this);
}
wijmo.viewer.RequestEventArgs.prototype = new wijmo.EventArgs();
wijmo.viewer.RequestEventArgs._wjDict = _wjMerge(wijmo.EventArgs._wjDict, {url:2,settings:2});
wijmo.viewer.RequestEventArgs._wjClass = true;
...
/// <field name="beforeSendRequest" type="wijmo.Event">Occurs before every request sent to the server.
/// 
...
/// 
/// For example, "http://demos.componentone.com/ASPNET/c1webapi/4.0.20172.105/api/report".</field>
...
this.beforeSendRequest = new wijmo.Event('wijmo.viewer.RequestEventArgs');
_wjReownEvents(this);
}
...
wijmo.viewer.ViewerBase.prototype.onBeforeSendRequest = function(e) {
/// <summary>Raises the @see:beforeSendRequest event.</summary>
/// <param name="e" type="wijmo.viewer.RequestEventArgs" optional="false">The @see:RequestEventArgs object.</param>
}
...
wijmo.viewer.ViewerBase._wjDict = _wjMerge(wijmo.Control._wjDict, {pageIndexChanged:1,viewModeChanged:1,selectMouseModeChanged:1,mouseModeChanged:1,fullScreenChanged:1,zoomFactorChanged:1,queryLoadingData:1,beforeSendRequest:1,serviceUrl:2,filePath:2,requestHeaders:2,thresholdWidth:2,zoomMode:2,zoomFactor:2,viewMode:2,selectMouseMode:2,mouseMode:2,fullScreen:2,pageIndex:2});
...
/// <field name="parameters" type="Object">Gets or sets a dictionary of {name: value} pairs that describe the parameters used to run the report.
/// 
...
wijmo.viewer.ReportViewer.getReportNames = function(serviceUrl, reportFilePath, httpHandler) {
...
/// <param name="httpHandler" type="wijmo.viewer.IHttpRequestHandler" optional="true">The HTTP request handler. This parameter is optional.</param>
...
wijmo.viewer.ReportViewer.getReports = function(serviceUrl, path, data, httpHandler) {
...
wijmo.viewer.ReportViewer._wjDict = _wjMerge(wijmo.viewer.ViewerBase._wjDict, {reportName:2,paginated:2,parameters:2});
