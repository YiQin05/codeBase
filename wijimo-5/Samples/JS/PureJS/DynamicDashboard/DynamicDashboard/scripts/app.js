onload = function() {
    ...
    dashboard.addEventListener('click', function (e) {
        ...
        if (tile && !e.dataTransfer) { // TFS 327679 (ignore DragDropTouch events)
            if (wijmo.closest(e.target, '.glyphicon-remove')) {
                dashboard.removeChild(tile);
            } else if (wijmo.closest(e.target, '.glyphicon-pencil')) {
