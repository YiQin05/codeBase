Npm image for Wijmo ES2015 modules in CommonJS module format (minified)
=======================================================================
...
the NodeJS command prompt:
	...
	npm install ../wijmo_download/NpmImages/wijmo-es2015-commonjs-min
...
application:
	...
	"dependencies": {
	   "wijmo": "../wijmo_download/NpmImages/wijmo-es2015-commonjs-min",
	   … other libraries
	}
