  ...
  <div class="container missionDetail">
    ...
    <el-tabs type="border-card" @tab-click="handleClick" v-model="activeName" @tab-remove="removeTab">
      ...
      <el-tab-pane :label="NewMissionLabelName" name="addMission" :disabled="userType === '2'? true:false">
        <mission @toTab="toResultTab" />
      </el-tab-pane>
      <!-- :disabled="showPanel" -->
      <el-tab-pane :label="editLabelName" name="editMission" :disabled="showPanel" >
        <div class="editContain contain">
            <el-form :inline="true"  :model="formInline" size="mini" label-width="120px" class="formStyle">
              ...
              <el-form-item label="方向角" prop="directAngle">
                <el-input v-model="formInline.directAngle" disabled></el-input>
...
export default {
  ...
  methods: {
    ...
    show (index, row, directAngle) {
      ...
      this.formInline.directAngle = directAngle
      // 第一个参数是latitude，第二个是longitude
    ...
    changeMission () {
      ...
      params.append('takePhotoLongitude', parseFloat(this.formInline.takePhotoLongitude))
      params.append('takePhotoLatitude', parseFloat(this.formInline.takePhotoLatitude))
