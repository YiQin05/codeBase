<template>
    <div class="container" style="min-height: 783px">
      ...
      <div class="mapTop">
        <div class="celltree">
          <cellTree @selectCell="selectCell" @showDetail="showDetail"/>
        </div>
        <div id="cellMsg">{{cellMsg}}</div>
        <div class="map">
...
export default {
  ...
  methods: {
    showDetail (y) {
      this.cellMsg = arguments[1]
      let height = y + 'px'
      document.getElementById('cellMsg').style.top = height
    },
    clickImg (e) {
      this.showImg = true
      console.log(65341541)
      // 获取当前图片地址
