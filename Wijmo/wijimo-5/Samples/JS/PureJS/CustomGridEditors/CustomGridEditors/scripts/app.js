onload = function () {
    ...
    //});
    //flex.rowEditEnding.addHandler(function (s, e) {
    //    console.log('rowEditEnding');
    //});
    //flex.rowEditEnded.addHandler(function (s, e) {
    //    console.log('rowEditEnded');
    //});
    //flex.rowEditStarting.addHandler(function (s, e) {
    //    console.log('rowEditStarting');
    //});
    //flex.rowEditStarted.addHandler(function (s, e) {
    ...
    new CustomGridEditor(flex, 'time', wijmo.input.InputTime, {
        isEditable: true, // so users can enter values like "4:36 pm"
        format: 't',
