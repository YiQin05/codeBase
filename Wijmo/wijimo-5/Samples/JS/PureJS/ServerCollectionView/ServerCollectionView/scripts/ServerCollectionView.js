    ...
    (function (collections) {
                    ...
                    if (url) {
                        wijmo.httpRequest(url, {
                            ...
                            success: function (xhr) {
                                ...
                                _this._changeCount++; // update view
                                _this._getData();
                            },
                ...
                this._toGetData = setTimeout(function () {
                    ...
                    wijmo.httpRequest(url, {
                        ...
                        success: function (xhr) {
                            ...
                            // parse response
                            var response = _this._parseJSON(xhr.responseText);
                ...
                return JSON.parse(text, function (key, value) {
                    if (typeof value == 'string') {
                        ...
                        if (value.match(/^\/Date\(\d+\)\/$/)) {
                            ...
                            date = wijmo.changeType(value, wijmo.DataType.Date, null); // ISO 8601
                        }
        ...
        var ServerCollectionView = /** @class */ (function (_super) {
            ...
            ServerCollectionView.prototype._getConditionDefinition = function (cf, cond) {
                var expr = '', name = '[' + cf.column.binding + ']', val = this._encodeFilterValue(cond.value, cf.column.dataType), unquoted = wijmo.isString(cond.value) ? cond.value.replace(/'/g, '\'\'') : '';
