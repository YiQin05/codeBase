    ...
    (function (chart) {
        ...
        var FlexChartBase = /** @class */ (function (_super) {
            ...
            Object.defineProperty(FlexChartBase.prototype, "selectionMode", {
                ...
                set: function (value) {
                    value = wijmo.asEnum(value, chart.SelectionMode);
    ...
    (function (chart_1) {
        ...
        var Axis = /** @class */ (function () {
            ...
            Axis.prototype._getLogBase = function () {
                if (this._chart && this._chart._stacking === chart_1.Stacking.Stacked100pc) {
                    return 0;
                }
                return this.logBase;
            };
    ...
    (function (chart_1) {
        ...
        var SeriesBase = /** @class */ (function () {
            ...
            SeriesBase.prototype._drawFunnelLegendItem = function (engine, rect, index, style, symbolStyle) {
                ...
                if (name != null) {
                    chart_1.FlexChart._renderText(engine, name, new wijmo.Point(rect.left + hsym + 2 * marg, yc), 0, 1, chart_1.FlexChart._CSS_LABEL, chart_1.FlexChart._CSS_LEGEND);
                }
            };
            SeriesBase.prototype._getFunnelLegendName = function (index) {
                ...
                if (chart._xlabels && chart._xlabels.length && index < chart._xlabels.length) {
                    ...
                    if (chart._xDataType === wijmo.DataType.Date) {
                        name = chart_1.FlexChart._fromOADate(name);
                    }
                }
                if (name == null) {
                    name = this.name;
            ...
            SeriesBase.prototype._drawLegendItem = function (engine, rect, chartType, text, style, symbolStyle) {
                ...
                if (this._name) {
                    chart_1.FlexChart._renderText(engine, text, new wijmo.Point(rect.left + hsym + 2 * marg, yc), 0, 1, chart_1.FlexChart._CSS_LABEL, chart_1.FlexChart._CSS_LEGEND);
                }
            };
        ...
        var _SvgRenderEngine = /** @class */ (function () {
            ...
            _SvgRenderEngine.prototype.drawString = function (s, pt, className, style) {
                ...
                if (this._bbCache[key]) {
                    ...
                    text.setAttribute('y', (pt.y - (bb.y + bb.height)).toFixed(1));
                }
                else {
    ...
    (function (chart_1) {
        ...
        var _BasePlotter = /** @class */ (function () {
            ...
            _BasePlotter.prototype._renderLabelAndBorder = function (engine, s, pos, offset, pt, line, marg, border) {
                var lrct, lcss = 'wj-data-label', clcss = 'wj-data-label-line', bcss = 'wj-data-label-border', gcss = chart_1.FlexChart._CSS_DATA_LABELS;
                switch (pos) {
                    case chart_1.LabelPosition.Top: {
                        ...
                        pt.y -= marg + offset;
                        lrct = chart_1.FlexChart._renderText(engine, s, pt, 1, 2, lcss, gcss);
                        break;
                    }
                    case chart_1.LabelPosition.Bottom: {
                        ...
                        pt.y += marg + offset;
                        lrct = chart_1.FlexChart._renderText(engine, s, pt, 1, 0, lcss, gcss);
                        break;
                    }
                    case chart_1.LabelPosition.Left: {
                        ...
                        pt.x -= marg + offset;
                        lrct = chart_1.FlexChart._renderText(engine, s, pt, 2, 1, lcss, gcss);
                        break;
                    }
                    case chart_1.LabelPosition.Right: {
                        ...
                        pt.x += marg + offset;
                        lrct = chart_1.FlexChart._renderText(engine, s, pt, 0, 1, lcss, gcss);
                        break;
                    }
                    case chart_1.LabelPosition.Center:
                        lrct = chart_1.FlexChart._renderText(engine, s, pt, 1, 1, lcss, gcss);
                        break;
                }
                if (border && lrct) {
    ...
    (function (chart) {
        ...
        var _BarPlotter = /** @class */ (function (_super) {
            ...
            _BarPlotter.prototype.adjustLimits = function (dataInfo, plotRect) {
                ...
                if (this.rotated) {
                    if (!this.chart.axisY._getLogBase() && dataInfo.getDataTypeY() !== wijmo.DataType.Date) {
                        if (this.origin > ymax) {
                            ymax = this.origin;
                        }
                        ...
                        if (chart._DataInfo.isValid(datax) && chart._DataInfo.isValid(datay)) {
                            if (stacked) {
                                ...
                                if (datay > 0) {
                                    ...
                                    y0 = ay.convert(Math.max(sum, ay.actualMin));
                                    y1 = ay.convert(Math.max(sum + datay, ay.actualMin));
