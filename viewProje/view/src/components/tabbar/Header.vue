    ...
    <div>
        <div class="container top">
            ...
            <div class="demo-input-suffix search">
                <el-input placeholder="请输入您要查找的内容" v-model="headSearch">
        ...
        <div class="container navi">
            <el-menu :default-active="activeIndex" active-text-color="white" class="el-menu-demo" mode="horizontal" @select="handleSelect">
                ...
                <!-- <el-menu-item index="4"><router-link to="/inquire/:userID" tag="a">地图查询</router-link></el-menu-item> -->
                <!-- <el-submenu index="4" class="el-menu-item">
                  <template slot="title">场景查询</template>
                  <el-menu-item index="4-1"><router-link to="/inquire/:userID" tag="a">场景查询</router-link></el-menu-item>
                  <el-menu-item index="4-2"><router-link to="/inquire/map/:userID" tag="a">地图查询</router-link></el-menu-item>
                </el-submenu> -->
                <!-- <el-menu-item index="5"><router-link to="/statistics/:userID" tag="a">统计分析</router-link></el-menu-item> -->
                <el-menu-item index="4"><router-link to="/inquire/:userID" tag="a">数据管理</router-link></el-menu-item>
                <!-- <el-menu-item index="5"><router-link to="/management/:userID" tag="a">系统管理</router-link></el-menu-item> -->
