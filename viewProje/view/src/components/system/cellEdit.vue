<template>
    <div class="cellEdit">
        ...
        <el-form :inline="true" ref="form1" :model="editCell" :rules="rules" class="demo-form-inline demo-ruleForm" size="mini" label-width="120px">
            <!-- string类型 -->
            <el-form-item label="基站" prop="bscID">
              <el-select v-model="editCell.bscID" placeholder="请选择基站" :disabled="unEdit">
                  <el-option
            ...
            <el-form-item label="小区" prop="cellID">
              <el-select v-model="editCell.cellID" placeholder="请选择小区" :disabled="unEdit">
                  <el-option
                    v-for="item in cellList"
                    :key="item.cellID"
                    :label="item.bscName+ '/' + item.cellName"
                    :value="item.cellID">
                  </el-option>
              </el-select>
            </el-form-item>
        ...
        <el-form :inline="true" :rules="rules" :model="editCell" ref="form2" class="demo-form-inline demo-ruleForm" size="mini" label-width="120px">
            ...
            <el-form-item label="小区位置" prop="lac">
                <el-input v-model="editCell.lac"></el-input>
                                                                ...
                                                                <!-- 此处ref的名字不连贯 -->
        <el-form :inline="true" :rules="rules" :model="editCell" ref="form7" class="demo-form-inline demo-ruleForm" size="mini" label-width="120px">
            <!-- string类型 -->
            <el-form-item label="基站名称" prop="bscName" class="single">
